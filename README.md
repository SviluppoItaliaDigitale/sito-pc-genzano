...
| [`04a-hugo-shortcode-partial.md`](.claude/rules/04a-hugo-shortcode-partial.md) | Shortcode (`foto`, `pittogramma`, `cosa-non-fare`, `chi-chiamare`, `pagina-emergenza-lite`), render hook tabelle/link, partial (article-cover, leggi-ad-alta-voce, articolo-navigazione, articoli-correlati, share buttons, modal SOS-112, striscia pittogrammi, FAQ accordion). |
