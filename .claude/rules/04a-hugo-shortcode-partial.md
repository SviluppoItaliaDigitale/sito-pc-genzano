...
- **Viste raccoglibili** in `MIA_VISTE`/`MIA_FN`: escluse quelle che incorporano un riquadro di terzi o una tela (Windy, traffico, radio) — non sono schede, e duplicarle aprirebbe due volte lo stesso servizio esterno.
...
- Una scheda scelta che al momento non c'è (la sua fonte non ha dati) **non fa sparire nulla**: la Mia Sala lo dice in una riga e la scheda ricompare da sola.
