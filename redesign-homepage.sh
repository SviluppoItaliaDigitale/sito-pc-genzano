...
<section class="hero-section" aria-label="Benvenuto">
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-7">
        <h1>Protezione Civile<br>Genzano di Roma</h1>
        <p class="lead">Gruppo Comunale Volontari — al servizio della comunita dal 1981.</p>
        <div class="mt-4">
      ...
      <div class="col-lg-5 d-none d-lg-block text-end" style="position:relative;z-index:1;">
        <div class="stats-hero">
          <div class="row g-3">
            <div class="col-6"><div class="stat-hero-item"><span class="stat-hero-num" data-count="44">0</span><span class="stat-hero-label">Anni</span></div></div>
            <div class="col-6"><div class="stat-hero-item"><span class="stat-hero-num" data-count="8">0</span><span class="stat-hero-label">Automezzi</span></div></div>
            <div class="col-6"><div class="stat-hero-item"><span class="stat-hero-num" data-count="20">0</span><span class="stat-hero-label">Emergenze</span></div></div>
            <div class="col-6"><div class="stat-hero-item"><span class="stat-hero-num" data-count="365">0</span><span class="stat-hero-label">Giorni l'anno</span></div></div>
          </div>
        </div>
      </div>
    </div>
...
<section class="py-4 bg-white" aria-labelledby="quickactions-heading">
  <div class="container">
    <div class="row">
...
<!-- NOTIZIE STILE COMUNE DI GENZANO -->
...
<section class="notizie-section fade-in-up" aria-labelledby="notizie-heading">
  <div class="container">
    ...
    <div class="row">
      <!-- NOTIZIA PRINCIPALE (grande, a sinistra) -->
      ...
      <div class="col-lg-6 mb-4">
        <a href="{{ .Permalink }}" class="card card-notizia-hero text-decoration-none h-100">
          ...
          <div class="card-body">
            ...
            <p class="text-muted">{{ .Summary | truncate 200 }}</p>
          </div>
        </a>
      </div>
      {{ end }}
      <!-- NOTIZIE SECONDARIE (piccole, a destra) -->
      <div class="col-lg-6">
          ...
          <div class="row g-0">
            ...
            <div class="col-8">
              <div class="card-body py-2 px-3">
                {{ with .Params.badge }}
                <span class="notizia-categoria {{ . | lower }}" style="font-size:0.6rem;">{{ . }}</span>
                {{ end }}
      ...
      <div class="col-lg-4 mt-3 mt-lg-0">
        <div class="card bg-warning bg-opacity-10 border-warning">
          <div class="card-body p-3 d-flex align-items-center">
            ...
            <div>
              <strong class="small">IT-alert</strong>
              <p class="small text-muted mb-0">Sistema di allarme pubblico.</p>
            </div>
