...
description: "Sigle e termini tecnici spiegati in parole semplici: COC, DPC, IT-alert, NUE 112, PAI, AeDES, AIB e altri concetti utili."
layout: "single"
sitemap:
  priority: 0.7
  changefreq: monthly
...
### PCTO
Percorsi per le Competenze Trasversali e l'Orientamento. Sono attività formative per studenti della scuola secondaria di secondo grado. Possono essere valutati anche con organizzazioni di protezione civile, se ci sono condizioni, progetto formativo, coperture e disponibilità operative.
...
<p class="mb-0"><i class="bi bi-bookmark-plus me-2" aria-hidden="true"></i><strong>Manca un termine?</strong> Scrivi a <a href="mailto:segreteria@protezionecivilegenzano.it">segreteria@protezionecivilegenzano.it</a>.</p>
</div>
