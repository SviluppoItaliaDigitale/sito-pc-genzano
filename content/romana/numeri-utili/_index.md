...
<h2 class="h4 text-danger fw-bold"><i class="bi bi-telephone-fill me-2" aria-hidden="true"></i>În caz de urgență sunați la 112</h2>
<p class="mb-0 mt-2"><span class="fs-1 fw-bold text-danger">112</span></p>
<p class="mb-0"><strong>Numărul Unic European de Urgență (NUE)</strong> — pentru orice urgență: sanitară, ordine publică, incendii, salvare tehnică.</p>
</div>
</div>

## Numere de urgență și salvare

În regiunea Lazio, din 2017, **singurul număr la care se sună în caz de urgență este 112**. Toate apelurile ajung la Centrala Unică a NUE, care trimite intervenția la serviciul competent (Pompieri, urgență sanitară, Carabinieri, Poliție, incendii forestiere).

| Număr | Serviciu | Când să sunați |
|---|---|---|
...
- **Sediu:** Via Sicilia, 13-15 — 00045 Genzano di Roma (RM)
