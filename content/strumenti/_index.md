...
{{< link-card url="/monitor/" icon="bi-display" titolo="Monitor sala situazioni (sperimentale)" desc="Le stesse fonti su una sola schermata scura, con mappa a tutta pagina: pensata per lo schermo della sede durante un turno di monitoraggio." >}}
</div>
