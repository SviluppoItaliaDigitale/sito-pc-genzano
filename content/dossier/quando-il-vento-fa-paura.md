...
sezioni:
  ...
  - { id: "fisica", label: "Cos'è il vento" }
  - { id: "beaufort", label: "Scala Beaufort" }
  - { id: "ianos", label: "Ianos 2020" }
  - { id: "milton", label: "Milton 2024" }
  - { id: "spazio", label: "Dall'orbita" }
  - { id: "vaia", label: "Vaia 2018" }
  - { id: "callum", label: "Callum 2018" }
  - { id: "downburst", label: "Downburst o tromba?" }
  - { id: "foehn", label: "Il favonio" }
  - { id: "italia", label: "Il vento in Italia" }
  - { id: "casa", label: "Genzano" }
  - { id: "fine", label: "Cosa fare" }
---

{{< dossier-hero id="inizio" image="/images/dossier/vento-hero.webp" alt="L'occhio di un grande uragano visto dall'alto: un vortice di nubi bianche compatte ruota attorno a un foro centrale che lascia intravedere il mare scuro" eyebrow="Dossier · Vento forte e schianti" title="Quando il vento<br>fa paura" sub="L'aria in movimento è energia. Dal medicane greco all'uragano americano, fino agli alberi che cadono nei Castelli Romani." credito="Immagine NASA dell'occhio dell'uragano Florence dallo spazio · pubblico dominio" >}}

{{< dossier-scena id="fisica" image="/images/dossier/vento-fisica-vento.webp" alt="Una grande nube temporalesca a forma di incudine si sviluppa sopra una collina boscosa al tramonto" align="top" kicker="Cos'è il vento" title="Aria che corre<br>verso il vuoto" credito="Foto: Simon Eugster · CC BY-SA 3.0, via Wikimedia Commons" >}}
...
{{< dossier-dati id="beaufort" >}}
{{< dossier-dato to="49" unita=" km/h" label="**Forza 6** Beaufort — vento teso: gli ombrelli diventano difficili da usare" >}}
{{< dossier-dato to="74" unita=" km/h" label="**Forza 8** — burrasca: si spezzano i rami, è difficile camminare" >}}
{{< dossier-dato to="102" unita=" km/h" label="**Forza 10** — tempesta: alberi sradicati, danni alle case" >}}
...
{{< dossier-scena id="spazio" image="/images/dossier/vento-iss-spazio.webp" alt="Vista ravvicinata dell'occhio dell'uragano Florence dalla Stazione Spaziale Internazionale: il vortice di nubi bianche si apre su un foro centrale dove si intravede il mare" align="top" kicker="Dall'orbita" title="Un ciclone visto<br>dallo spazio" credito="Foto: Alexander Gerst / NASA · pubblico dominio, via Wikimedia Commons" >}}
...
{{< dossier-scena id="downburst" image="/images/dossier/vento-tornado-moore.webp" alt="Un grande tornado a cuneo scuro avvolge l'orizzonte di una campagna verde, sotto un cielo temporalesco nerissimo: il tornado F5 di Moore, Oklahoma, 3 maggio 1999" align="right" kicker="Due nemici diversi" title="Downburst o<br>tromba d'aria?" credito="Foto: Mike Eilts / NSSL-NOAA · pubblico dominio, via Wikimedia Commons" >}}
...
{{< dossier-scena id="foehn" image="/images/dossier/vento-foehn.webp" alt="Un'auto percorre una strada al tramonto verso le montagne, sotto una netta fascia di nubi spazzate dal vento: il muro di foehn sul versante sottovento" align="right" kicker="Dai monti" title="Il favonio, vento caldo<br>che scende" credito="Foto: FPIC · CC BY-SA 3.0, via Wikimedia Commons" >}}
...
{{< dossier-hotspot id="italia" image="/images/dossier/vento-hotspot-italia.webp" alt="Mappa fisica dell'Italia con i rilievi montuosi, le pianure e le coste" titolo="Dove il vento colpisce in Italia" testo="Nessuna area è immune. Tocca i punti per scoprire i tipi di evento ventoso che hanno segnato il Paese." >}}
{{< dossier-punto x="40" y="14" titolo="Triveneto — Vaia 2018" >}}Venti fino a 200 km/h e 14 milioni di alberi schiantati: il più grave evento forestale italiano recente.{{< /dossier-punto >}}
{{< dossier-punto x="44" y="32" titolo="Pianura padana ed emiliana" >}}D'estate, downburst e trombe d'aria nascono da temporali violenti sulla pianura calda e umida.{{< /dossier-punto >}}
{{< dossier-punto x="78" y="82" titolo="Mediterraneo centrale" >}}Qui si formano i medicane, cicloni quasi-tropicali con raffiche e mareggiate, come Ianos vicino alla Grecia.{{< /dossier-punto >}}
{{< dossier-punto x="50" y="46" titolo="Castelli Romani / Lazio" >}}Viali alberati e pinete vulnerabili: downburst urbani e interventi ricorrenti per alberi, pali e cartelli caduti.{{< /dossier-punto >}}
{{< /dossier-hotspot >}}

{{< dossier-scena id="casa" image="/images/dossier/vento-castelli-locale.webp" alt="Strada di un centro abitato laziale dopo una forte raffica: un'auto bianca schiacciata da un tetto crollato, detriti e tegole sull'asfalto, persone e un'ambulanza sul posto" align="right" kicker="Qui, a casa nostra" title="Genzano e i Castelli:<br>gli alberi che cadono" credito="Foto: MeteoNetwork.it · CC BY-SA 4.0, via Wikimedia Commons" >}}
...
{{< dossier-chiusura id="fine" titolo="Il vento si rispetta, prima che arrivi" cta1="Vento forte: cosa fare" cta1url="/rischi-prevenzione/vento-forte/" cta2="Le allerte di oggi" cta2url="/allerte-meteo/" >}}
...
- **Sul nostro sito:** [Quando scoppia il temporale](/dossier/quando-scoppia-il-temporale/) · [Neve e gelo](/dossier/neve-e-gelo/) · [La catena dell'allerta](/dossier/la-catena-dell-allerta/) · [Vento forte: cosa fare](/rischi-prevenzione/vento-forte/) · [Allerte meteo](/allerte-meteo/) · [Strumenti in tempo reale](/cruscotto/) · [Temporali intensi](/rischi-prevenzione/temporali-intensi/) · [Rischio incendio](/rischi-prevenzione/rischio-incendio/).
