...
sezioni:
  ...
  - { id: "autorigenerante", label: "Autorigenerante" }
  - { id: "marche-2022", label: "Marche 2022" }
  - { id: "grandine", label: "La grandine" }
  - { id: "downburst", label: "Il downburst" }
  - { id: "tornado", label: "Le trombe d'aria" }
  - { id: "fulmini", label: "I fulmini" }
  - { id: "radar", label: "Il radar" }
  - { id: "hotspot", label: "Dove colpiscono" }
  - { id: "autoprotezione", label: "Cosa fare" }
  - { id: "fine", label: "A casa nostra" }
---

{{< dossier-hero id="inizio" image="/images/dossier/temporali-hero.webp" alt="Imponente nube temporalesca a incudine domina il cielo sopra i palazzi di una città al tramonto, con un uccello in volo" eyebrow="Dossier · Temporali intensi" title="Quando scoppia<br>il temporale" sub="Non è solo pioggia. È una macchina d'aria che fabbrica fulmini, grandine e raffiche — fino al cortile di casa." credito="Cumulonembo a incudine su una città · foto Marek Wikipedista · CC BY-SA 4.0, via Wikimedia Commons" >}}

{{< dossier-scena id="anatomia" image="/images/dossier/temporali-cumulonembo.webp" alt="Grande cumulonembo con la caratteristica sommità a incudine che si allarga nel cielo azzurro sopra una periferia con tetti rossi" align="top" kicker="Che cos'è" title="La fabbrica<br>nel cielo" credito="Cumulonembo con sommità a incudine · foto Marek Wikipedista · CC BY-SA 4.0, via Wikimedia Commons" >}}
...
{{< dossier-dato to="19" unita=" cm" label="Il chicco di **grandine** più grande mai misurato in Europa (Friuli, 2023)" >}}
{{< dossier-dato to="400" unita=" mm" label="La pioggia caduta in **6 ore** nell'alluvione lampo delle Marche (2022)" >}}
{{< dossier-dato to="768" unita=" km" label="Il **fulmine** più lungo certificato al mondo, sugli Stati Uniti (record WMO, 2020)" >}}
{{< dossier-dato to="160" unita=" km/h" label="Le **raffiche** possibili in un downburst, capaci di abbattere alberi" >}}
{{< /dossier-dati >}}

{{< dossier-scena id="autorigenerante" image="/images/dossier/temporali-mcs-satellite.webp" alt="Immagine satellitare di un vasto sistema temporalesco compatto e bianco visto dallo spazio sopra un territorio verde" align="top" kicker="Ordinario o autorigenerante" title="Il temporale<br>che non se ne va" credito="Sistema temporalesco dallo spazio · NOAA GOES-East · pubblico dominio, via Wikimedia Commons" >}}
...
{{< dossier-scena id="grandine" image="/images/dossier/temporali-grandine.webp" alt="Grosso chicco di grandine sferico appoggiato accanto a un righello che ne mostra le dimensioni, circa sei centimetri, su sfondo nero" align="left" kicker="La grandine gigante" title="Ghiaccio grande<br>come una pesca" credito="Chicco di grandine con righello · NOAA National Severe Storms Laboratory · pubblico dominio, via Wikimedia Commons" >}}
...
{{< dossier-scena id="downburst" image="/images/dossier/temporali-downburst.webp" alt="Bosco con tutti gli alberi spezzati e abbattuti nella stessa direzione dopo una raffica discendente di temporale" align="top" kicker="Il downburst" title="Il pugno d'aria<br>che scende dal cielo" credito="Alberi abbattuti da downburst · Todd Shea, NOAA/National Weather Service · pubblico dominio, via Wikimedia Commons" >}}
...
{{< dossier-scena id="tornado" image="/images/dossier/temporali-tornado.webp" alt="Tornado con imbuto scuro che scende dalla base di una nube temporalesca fino al suolo in aperta campagna, con un albero in primo piano" align="top" kicker="Le trombe d'aria" title="Anche l'Italia<br>ha i suoi tornado" credito="Tornado in aperta campagna (immagine illustrativa, non scattata in Italia) · Daphne Zaras, NOAA · pubblico dominio, via Wikimedia Commons" >}}
...
{{< dossier-scena id="fulmini" image="/images/dossier/temporali-fulmini.webp" alt="Numerosi fulmini ramificati che attraversano il cielo notturno violaceo durante un temporale, sopra un orizzonte di campagna in ombra" align="left" kicker="I fulmini" title="La scintilla<br>più temibile" credito="Fulmini nube-suolo durante un temporale notturno · NOAA National Severe Storms Laboratory · pubblico dominio, via Wikimedia Commons" >}}
...
In Italia le fulminazioni sono monitorate da terra dalla rete **SIRF** dal 1994. Dal 2026 le guarda anche dall'alto un satellite europeo: [Il satellite che vede i fulmini](/comunicazioni/2026-08-31-mtg-i2-satellite-fulmini-europa/). La mortalità è bassa, ma evitabile con i comportamenti giusti. Le creste, i campi aperti e le sponde dei laghi di **Nemi** e **Albano** sono i luoghi dove, durante un temporale, non bisogna farsi sorprendere.
{{< /dossier-scena >}}

{{< dossier-scena id="radar" image="/images/dossier/temporali-radar.webp" alt="Schermata di radar meteo con un'area colorata a forma di uncino, dal blu al rosso, che indica una supercella temporalesca, con la scala dei colori sulla destra" align="left" kicker="Radar e nowcasting" title="Vedere il temporale<br>prima che arrivi" credito="Eco radar di una supercella · NOAA National Severe Storms Laboratory · pubblico dominio, via Wikimedia Commons" >}}
...
{{< dossier-scena id="autoprotezione" image="/images/dossier/temporali-autoprotezione.webp" alt="Gocce di pioggia su un vetro che sfocano i palazzi della città sullo sfondo, viste dall'interno durante un temporale" align="top" kicker="Cosa fare" title="La regola<br>del 30/30" credito="Pioggia sul vetro durante un temporale · foto Pongola · CC BY 4.0, via Wikimedia Commons" >}}
...
{{< dossier-chiusura id="fine" titolo="Il temporale ordinario che diventa pericoloso" cta1="Temporali intensi: cosa fare" cta1url="/rischi-prevenzione/temporali-intensi/" cta2="Le allerte di oggi" cta2url="/allerte-meteo/" >}}
...
- **Sul nostro sito:** [Troppa acqua](/dossier/troppa-acqua/) · [Il satellite che vede i fulmini](/comunicazioni/2026-08-31-mtg-i2-satellite-fulmini-europa/) · [Quando il vento fa paura](/dossier/quando-il-vento-fa-paura/) · [La catena dell'allerta](/dossier/la-catena-dell-allerta/) · [Temporali intensi: cosa fare](/rischi-prevenzione/temporali-intensi/) · [Rischio idrogeologico](/rischi-prevenzione/rischio-idrogeologico/) · [Allerte meteo](/allerte-meteo/) · [Strumenti in tempo reale](/cruscotto/).
