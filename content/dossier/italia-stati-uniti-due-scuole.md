...
sezioni:
  ...
  - { id: "scala", label: "Gli uragani" }
  - { id: "incendi", label: "Il fuoco" }
  - { id: "origini", label: "Le origini" }
  - { id: "storia", label: "Due nascite" }
  - { id: "governance", label: "Modello USA" }
  - { id: "dichiarazione", label: "Dichiarare il disastro" }
  - { id: "sussidiarieta", label: "Modello italiano" }
  ...
  - { id: "allertamento", label: "Allertare" }
  - { id: "formazione", label: "Formare" }
  - { id: "cultura", label: "Educare" }
...
{{< dossier-scena id="incendi" image="/images/dossier/usa-incendi.webp" alt="Immagine satellitare della California e dell'ovest degli Stati Uniti con numerosi focolai di incendio segnalati in rosso e ampie scie di fumo che si allungano sul territorio" align="left" kicker="Stati Uniti · gli incendi" title="E poi<br>il fuoco" credito="Foto: NASA · MODIS Rapid Response Team · pubblico dominio · 2018" >}}
Poi c'è il **fuoco**. Ogni estate gli incendi corrono per settimane nei boschi della California e dell'ovest, bruciando aree vastissime e minacciando intere città.
...
{{< dossier-dato to="2018" label="Il **Codice della Protezione Civile** (decreto legislativo 1) riordina tutto il sistema italiano in un testo unico" >}}
{{< /dossier-dati >}}

{{< dossier-scena id="storia" image="/images/dossier/fuoco-canadair.webp" alt="Un aereo Canadair antincendio vola a bassa quota su uno specchio d'acqua per riempire i serbatoi, sollevando una scia di spruzzi" align="top" kicker="Due percorsi diversi" title="Due nascite,<br>due bisogni" credito="Foto: Albarubescens · CC BY-SA 4.0, via Wikimedia Commons" >}}
Negli **Stati Uniti** la protezione civile nasce dalla **difesa civile** della Guerra Fredda: rifugi antiatomici, sirene, preparazione della popolazione a un attacco. Da lì, nel 1979, l'unificazione di decine di uffici dispersi in un'unica agenzia, la **FEMA**.

In **Italia** la spinta arriva dalle catastrofi: la diga del **Vajont** (1963), il terremoto del **Friuli** (1976), quello dell'**Irpinia** (1980), gestiti tra ritardi e improvvisazione. Da quelle ferite nasce un'idea nuova, legata al nome di **Giuseppe Zamberletti**: un servizio permanente e organizzato, che mette insieme lo Stato, le Regioni, i Comuni e i cittadini.
...
{{< dossier-scena id="sussidiarieta" image="/images/dossier/acqua-emilia-2023.webp" alt="Veduta aerea di una casa di campagna rimasta isolata come un'isola, con i suoi alberi e il giardino, in mezzo all'acqua marrone che ha sommerso la pianura intorno" align="top" kicker="Italia · modello sussidiario" title="Si parte<br>dal Comune" credito="Foto: Cesare Barillà · CC BY-SA 4.0, via Wikimedia Commons · 2023" >}}
Il modello italiano è **sussidiario e dal basso**. La prima autorità di protezione civile è il **Sindaco**: conosce il territorio, attiva il Comune, informa la popolazione. Quando l'evento cresce intervengono **Regione** e **Stato**, a sostegno di chi sta sotto, senza scavalcarlo.
...
{{< dossier-hotspot id="ics" image="/images/dossier/usa-nrcc-sala.webp" alt="Sala operativa della FEMA: un open space di postazioni con operatori ai computer e una grande insegna «FEMA» sulla parete di fondo" titolo="ICS · la catena di comando americana" testo="Negli Stati Uniti ogni emergenza è gestita con l'**Incident Command System (ICS)**, nato nel 1972 dagli incendi della California (progetto FIRESCOPE) e oggi cuore del sistema nazionale **NIMS** (2004). È una struttura di comando unica, **scalabile** da un piccolo incidente a un disastro nazionale, organizzata sempre nelle stesse **cinque aree funzionali**. Tocca i punti per scoprirle." >}}
{{< dossier-punto x="20" y="40" titolo="Comando" >}}
Un'unica figura, l'**Incident Commander**, ha la responsabilità complessiva. Decisioni rapide e una linea di comando chiara, dal piccolo incidente al disastro.
{{< /dossier-punto >}}
{{< dossier-punto x="40" y="62" titolo="Operazioni" >}}
Le squadre che agiscono sul campo: spegnimento, soccorso, messa in sicurezza. È il braccio operativo dell'emergenza.
{{< /dossier-punto >}}
{{< dossier-punto x="58" y="38" titolo="Pianificazione" >}}
Raccoglie le informazioni, segue l'evoluzione dell'evento e prepara il piano d'azione per le ore successive.
{{< /dossier-punto >}}
{{< dossier-punto x="74" y="64" titolo="Logistica" >}}
Mezzi, materiali, vitto, alloggi, comunicazioni: tutto ciò che serve a far funzionare la risposta.
{{< /dossier-punto >}}
{{< dossier-punto x="87" y="36" titolo="Amministrazione e finanze" >}}
Costi, contratti, rimborsi. In un sistema dove i fondi si aprono con una dichiarazione, contare le spese è parte della risposta.
{{< /dossier-punto >}}
{{< /dossier-hotspot >}}

{{< dossier-scena id="augustus" image="/images/dossier/italia-tendopoli-aquila.webp" alt="Campo di accoglienza della Protezione Civile dopo un terremoto: tende, un gazebo bianco e volontari in divisa gialla fluorescente, con uno striscione «Provincia di Rovigo — Servizio Protezione Civile»" align="top" kicker="Italia · il Metodo Augustus" title="Le funzioni<br>di supporto" credito="Foto: Trevi.zz · CC BY-SA 4.0, via Wikimedia Commons · L'Aquila 2009" >}}
L'Italia organizza l'emergenza con il **Metodo Augustus** (1997), che si ispirò proprio all'esperienza della FEMA ma scelse una strada diversa: non una catena di comando, ma una rete di **funzioni di supporto**.

Ogni funzione è un settore — con un **referente** che la tiene viva **in tempo di pace** e la coordina in emergenza. A livello comunale le funzioni sono **nove**: tecnica e pianificazione; sanità e assistenza sociale; **volontariato**; materiali e mezzi; servizi essenziali; censimento danni; strutture operative e viabilità; telecomunicazioni; assistenza alla popolazione. A livello provinciale diventano **quattordici**.
...
{{< dossier-chiusura id="fine" titolo="Due strade, una sola meta" cta1="Il Servizio Nazionale" cta1url="/conoscere/servizio-nazionale/" cta2="L'Europa che si soccorre" cta2url="/dossier/l-europa-che-si-soccorre/" >}}
Non esiste un modello «giusto»: ognuno è figlio della storia e della geografia del suo Paese. Gli **Stati Uniti** hanno costruito una macchina federale potente, fatta per disastri di scala continentale, con una catena di comando — l'ICS — che funziona ovunque allo stesso modo. L'**Italia** ha scelto la **prossimità** — il Sindaco, le Regioni, lo Stato a sostegno — e il **Metodo Augustus**, costruito su un **volontariato diffuso** che è la sua forza più rara.

Le due scuole, del resto, si parlano da sempre: il Metodo Augustus nacque guardando alla FEMA, e oggi i sistemi di allarme e gli standard di soccorso sono sempre più condivisi.

Quello che conta, ovunque, resta la prima protezione civile: **cittadini informati e pronti**. Qui da noi, in emergenza, il numero è il **112**.
{{< /dossier-chiusura >}}
