---
title: "L'esercito gentile"
date: 2026-06-10T18:30:00+02:00
type: "dossier"
tema: "sistema"
description: "Oltre un milione e trecentomila volontari, più di cinquemila organizzazioni: il volontariato di protezione civile è un unicum italiano. Chi sono, da dove vengono, cosa dice la legge — e perché funziona."
image: "/images/2026-05-20-squadra-genzano-corso-base-sala-operativa-lazio.webp"
image_alt: "La squadra di volontari del corso base nella Sala Operativa della Regione Lazio, in posa di gruppo con un cane da soccorso"
autore: "Gruppo Comunale Volontari PC Genzano"
tts: false
indice: false
sezioni:
  - { id: "inizio", label: "Apertura" }
  - { id: "chi", label: "Chi sono" }
  - { id: "numeri", label: "I numeri" }
  - { id: "radici", label: "Le radici" }
  - { id: "legge", label: "La legge" }
  - { id: "casa", label: "A casa nostra" }
  - { id: "fine", label: "Cosa resta" }
---

{{< dossier-hero id="inizio" image="/images/2026-05-20-squadra-genzano-corso-base-sala-operativa-lazio.webp" alt="Decine di volontari di protezione civile in divisa, in posa di gruppo nell'aula della Sala Operativa della Regione Lazio, con un cane da soccorso labrador accucciato in prima fila" eyebrow="Dossier · Il sistema" title="L'esercito<br>gentile" sub="Più di un milione e trecentomila persone, oltre cinquemila organizzazioni: il volontariato di protezione civile è la più grande forza civica d'Europa. Non ha armi e non riceve stipendio. E quando l'Italia trema, brucia o si allaga, arriva." credito="Foto: Gruppo Comunale Volontari di Protezione Civile di Genzano di Roma" >}}

{{< dossier-scena id="chi" image="/images/2026-05-15-formia-giro-volontari-territorio.webp" alt="Tre volontari del Gruppo in divisa rossa e blu, abbracciati e sorridenti davanti ai mezzi di servizio" align="right" kicker="Chi sono" title="Gente normale,<br>preparata" credito="Foto: Gruppo Comunale Volontari di Protezione Civile di Genzano di Roma" >}}
...
{{< dossier-scena id="radici" image="/images/2026-05-31-infiorata-squadra-volontari.webp" alt="Dieci volontari del Gruppo in maglia blu e pantaloni rosso-blu, in posa sorridente lungo la via dell'Infiorata di Genzano" align="left" kicker="Le radici" title="Otto secoli<br>di soccorso" credito="Foto: Gruppo Comunale Volontari di Protezione Civile di Genzano di Roma" >}}
...
{{< dossier-scena id="casa" image="/images/2026-05-02-albero-pericolante-genzano-volontari-taglio.webp" alt="Un volontario del Gruppo con casco e divisa rossa e blu lavora alla rimozione di un grosso ramo caduto su una strada di Genzano, accanto a un mezzo di servizio" align="right" kicker="A casa nostra" title="Il Gruppo Comunale:<br>la forma più vicina" credito="Foto: Gruppo Comunale Volontari di Protezione Civile di Genzano di Roma" >}}
...
{{< dossier-chiusura id="fine" titolo="La forza più rara" cta1="Diventa volontario" cta1url="/diventa-volontario/" cta2="Il volontariato nel Codice (Manuale)" cta2url="/manuale/25-commentario-codice-capo-5/" >}}
...
Se quella scelta ti somiglia, [comincia da qui](/diventa-volontario/). E in emergenza, sempre e solo il **112**.
{{< /dossier-chiusura >}}
...
- **Fonti:** [Dipartimento della Protezione Civile — il volontariato organizzato](https://volontariato.protezionecivile.gov.it/it/volontariato-di-protezione-civile/) (oltre 5.000 organizzazioni e oltre 1.300.000 volontari nell'Elenco nazionale) · [Codice della protezione civile, d.lgs. 1/2018, artt. 31-42 — Normattiva](https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:decreto.legislativo:2018-01-02;1) · D.M. 13 aprile 2011 (sicurezza del volontario) · sulle radici storiche: Misericordie (Firenze, 1244), Croce Rossa Italiana (1864), movimento delle Pubbliche Assistenze (XIX secolo).
- **Sul nostro sito:** [Diventa volontario](/diventa-volontario/) · [Chi siamo](/chi-siamo/) · [Il Capo V del Codice, articolo per articolo (Manuale)](/manuale/25-commentario-codice-capo-5/) · [La sicurezza del volontario (Manuale, Parte III)](/manuale/31-sicurezza-del-volontario/) · [Dossier: Gli angeli del fango](/dossier/angeli-del-fango-firenze-1966/).
