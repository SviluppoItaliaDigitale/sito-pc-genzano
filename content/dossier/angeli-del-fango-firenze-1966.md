...
sezioni:
  ...
  - { id: "arno", label: "L'Arno" }
  - { id: "disastro", label: "Il disastro" }
  - { id: "arte", label: "L'arte ferita" }
  - { id: "biblioteca", label: "I libri" }
  - { id: "angeli", label: "Gli angeli" }
  - { id: "eredita", label: "L'eredità" }
  - { id: "oggi", label: "Oggi" }
...
{{< dossier-scena id="eredita" image="/images/dossier/acqua-emilia-2023.webp" alt="Veduta aerea di una casa di campagna rimasta isolata in mezzo all'acqua marrone di un'alluvione, in Emilia-Romagna nel 2023" align="bottom" kicker="Da allora a oggi" title="Da quel fango,<br>il volontariato" credito="Foto: Cesare Barillà · CC BY-SA 4.0, via Wikimedia Commons · 2023" >}}
...
{{< dossier-chiusura id="fine" titolo="Il fango passa, l'esempio resta" cta1="Dalle macerie, un sistema" cta1url="/dossier/nascita-protezione-civile-italiana/" cta2="Diventa volontario" cta2url="/diventa-volontario/" >}}
...
Quella generosità spontanea, col tempo, è diventata un **sistema**: la Protezione Civile, i gruppi comunali, il volontariato organizzato che oggi è la nostra forza più rara. È la storia che raccontiamo nel dossier [«Dalle macerie, un sistema»](/dossier/nascita-protezione-civile-italiana/).

Se anche tu vuoi essere un angelo del fango dei nostri tempi, comincia da qui: [diventa volontario](/diventa-volontario/). E in emergenza, ricorda il **112**.
{{< /dossier-chiusura >}}
