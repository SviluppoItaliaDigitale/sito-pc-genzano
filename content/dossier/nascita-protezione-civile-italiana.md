...
sezioni:
  ...
  - { id: "friuli", label: "Friuli 1976" }
  - { id: "irpinia", label: "Irpinia 1980" }
  - { id: "zamberletti", label: "Zamberletti" }
  - { id: "macchina", label: "Nasce la macchina" }
  - { id: "leggi", label: "Le leggi" }
  - { id: "attivita", label: "Le attività" }
  - { id: "oggi", label: "Oggi" }
...
{{< dossier-scena id="macchina" image="/images/dossier/fuoco-canadair.webp" alt="Un aereo Canadair antincendio vola a bassa quota su uno specchio d'acqua per riempire i serbatoi, sollevando una scia di spruzzi" align="top" kicker="Dagli anni Ottanta a oggi" title="Nasce<br>la macchina" credito="Foto: Albarubescens · CC BY-SA 4.0, via Wikimedia Commons" >}}
Con il Dipartimento, lo Stato si dota di **mezzi propri** e di una **catena di comando**: la flotta aerea antincendio con i **Canadair**, le colonne mobili, i magazzini, le convenzioni con le strutture operative.

Ma l'idea di Zamberletti è più ampia: la protezione civile non è solo dello Stato. È un **sistema** che mette insieme Stato, Regioni, Comuni, vigili del fuoco, forze armate, comunità scientifica e — soprattutto — i **cittadini volontari**.
...
{{< dossier-scena id="oggi" image="/images/dossier/italia-tendopoli-aquila.webp" alt="Campo di accoglienza della Protezione Civile dopo un terremoto: tende, un gazebo bianco e volontari in divisa gialla fluorescente, con uno striscione «Provincia di Rovigo — Servizio Protezione Civile»" align="top" kicker="Il sistema alla prova" title="Quello che<br>siamo diventati" credito="Foto: Trevi.zz · CC BY-SA 4.0, via Wikimedia Commons · L'Aquila 2009" >}}
Oggi quel sistema si vede in azione a ogni emergenza. Dopo il terremoto dell'**Aquila** (2009) e in tante altre crisi, in poche ore sorgono **campi di accoglienza**, cucine da campo, presìdi sanitari: ognuno è una **funzione di supporto** che qualcuno ha preparato in tempo di pace.
...
Qui da noi, quando serve davvero, il numero resta il **112**.
{{< /dossier-chiusura >}}
...
- **Sul nostro sito:** [Vajont: la diga che resse](/dossier/vajont-la-diga-che-resse/) · [Messina 1908](/dossier/messina-1908-il-minuto/) · [Gli angeli del fango](/dossier/angeli-del-fango-firenze-1966/) · [Due scuole di soccorso](/dossier/italia-stati-uniti-due-scuole/) · [La nascita del Dipartimento della Protezione Civile](/comunicazioni/2026-04-29-nascita-dipartimento-protezione-civile-italia/) · [Il Servizio Nazionale](/conoscere/servizio-nazionale/) · [Diventa volontario](/diventa-volontario/) · [Glossario](/glossario/).
