...
sezioni:
  ...
  - { id: "territorio", label: "I nostri crateri" }
  - { id: "iride", label: "IRIDE (Italia)" }
  - { id: "notte", label: "Di notte" }
  - { id: "fine", label: "Conclusione" }
---

{{< dossier-hero id="inizio" image="/images/dossier/hero-terra.webp" alt="La Terra intera illuminata dal Sole vista dallo spazio: si riconoscono l'Africa, la penisola arabica e l'Antartide coperta di nuvole" eyebrow="Dossier · Osservare per proteggere" title="La Terra<br>vista dallo spazio" sub="Come i satelliti guardano il nostro pianeta — e ci aiutano a difendere il territorio." credito="NASA · equipaggio Apollo 17 (1972) · pubblico dominio" >}}

{{< dossier-scena id="occhi" image="/images/dossier/satellite.webp" alt="Rappresentazione di un satellite Copernicus Sentinel in orbita sopra l'oceano terrestre" align="left" kicker="Gli occhi sul pianeta" title="Sentinelle silenziose" credito="ESA / P. Carril · CC BY-SA 3.0 IGO" >}}
A centinaia di chilometri sopra le nostre teste, una flotta di satelliti **Copernicus** — il programma di osservazione della Terra dell'Unione Europea — fotografa il pianeta giorno e notte.

Non scattano cartoline: misurano **temperature, fumo, umidità del suolo, livello dei fiumi, qualità dell'aria**. Sono gli stessi dati che, a terra, diventano **bollettini, allerte e mappe** della protezione civile.
{{< /dossier-scena >}}

{{< dossier-dati id="numeri" >}}
{{< dossier-dato to="786" unita=" km" label="Da quassù i satelliti **Sentinel-2** fotografano la Terra" >}}
{{< dossier-dato to="5" unita=" giorni" label="Ogni quanto rivedono lo **stesso punto** del pianeta" >}}
...
{{< dossier-hotspot id="acqua" image="/images/dossier/alluvione.webp" alt="Confronto satellitare prima e dopo un'alluvione: a sinistra il fiume nella norma, a destra vaste aree allagate in blu" titolo="Troppa acqua, vista dall'alto" testo="A sinistra il territorio **prima**; a destra, **dopo** il passaggio del ciclone, l'acqua in blu che ha invaso la piana. I satelliti radar **vedono attraverso le nuvole**: mappano un'alluvione anche in piena tempesta, quando nessun aereo può volare. È il servizio europeo **Copernicus EMS**, attivabile dalle autorità durante le emergenze. *(Mozambico, ciclone Idai 2019 — © Pierre Markuse, dati Copernicus Sentinel modificati, CC BY 2.0.)*" >}}{{< /dossier-hotspot >}}
...
{{< dossier-punto x="84" y="20" titolo="Rivisto ogni 5 giorni" >}}Il satellite **Sentinel-2** rifotografa quest'area **ogni 5 giorni**: così seguiamo incendi estivi, frane e cambiamenti del territorio quasi in tempo reale.{{< /dossier-punto >}}
{{< /dossier-hotspot >}}
...
Di notte le città si accendono e i sensori cambiano sguardo: dal **visibile** all'**infrarosso**. Un incendio, una nube di fumo, un blackout su vasta scala si vedono **anche al buio**.

È la ragione per cui il monitoraggio del territorio non ha orari: **24 ore su 24**, ogni giorno dell'anno.
{{< /dossier-scena >}}

{{< dossier-chiusura id="fine" titolo="Dal satellite al cittadino" cta1="Apri il cruscotto in tempo reale" cta1url="/cruscotto/" cta2="Le allerte di oggi" cta2url="/allerte-meteo/" >}}
Tutto questo non resta nello spazio. Ogni immagine diventa un **dato**, ogni dato un'**allerta**, ogni allerta un **gesto di prevenzione** che puoi fare tu. È così che la protezione civile trasforma uno sguardo dall'orbita in **sicurezza per il territorio**.
{{< /dossier-chiusura >}}
...
- **Sul nostro sito:** [IRIDE operativa nel 2026](/comunicazioni/2026-07-03-iride-costellazione-osservazione-terra-operativa/) · [Cruscotto del territorio](/cruscotto/) · [Allerte meteo](/allerte-meteo/) · [Rischi e prevenzione](/rischi-prevenzione/).
