---
title: "Gli animali nell'emergenza"
date: 2026-06-10T18:45:00+02:00
type: "dossier"
tema: "rischi"
description: "I cani che cercano i dispersi e gli animali da mettere in salvo: il lato a quattro zampe dei disastri. Le unità cinofile, la svolta del 2016 nelle aree di accoglienza, il kit per cani e gatti e gli errori da non fare."
image: "/images/dossier/animali-cane-soccorso.webp"
image_alt: "Un cane da soccorso riceve una carezza dal suo conduttore dopo la ricerca tra le macerie durante un'esercitazione"
autore: "Gruppo Comunale Volontari PC Genzano"
tts: false
indice: false
sezioni:
  - { id: "inizio", label: "Apertura" }
  - { id: "cinofile", label: "Chi cerca" }
  - { id: "numeri", label: "I numeri" }
  - { id: "salvare", label: "Chi va salvato" }
  - { id: "kit", label: "Il kit" }
  - { id: "errori", label: "Gli errori" }
  - { id: "fine", label: "Cosa resta" }
---

{{< dossier-hero id="inizio" image="/images/dossier/animali-cane-soccorso.webp" alt="Un cane da soccorso con la lingua di fuori riceve una carezza dal suo conduttore in guanti da lavoro, dopo un turno di ricerca tra le macerie di un'esercitazione" eyebrow="Dossier · I rischi" title="Gli animali<br>nell'emergenza" sub="Nei disastri gli animali stanno da entrambe le parti: c'è chi cerca i dispersi col proprio naso, e chi aspetta di essere messo in salvo insieme alla sua famiglia. Questa è la storia del lato a quattro zampe della protezione civile." credito="Cane da soccorso col suo conduttore dopo la ricerca, esercitazione Vibrant Response 2014 · foto Sgt. John Healy / U.S. Army · pubblico dominio, via Wikimedia Commons" >}}

{{< dossier-scena id="cinofile" image="/images/2026-05-20-squadra-genzano-corso-base-sala-operativa-lazio.webp" alt="La squadra di volontari al corso base nella Sala Operativa della Regione Lazio, con un labrador nero da soccorso accucciato in prima fila" align="right" kicker="Chi cerca" title="Il naso che vale<br>più di un radar" credito="Foto: Gruppo Comunale Volontari di Protezione Civile di Genzano di Roma — il corso base regionale, con un cane da soccorso in prima fila" >}}
...
{{< dossier-scena id="salvare" image="/images/dossier/acqua-emilia-2023.webp" alt="Casa di campagna isolata dall'acqua marrone durante l'alluvione dell'Emilia-Romagna del 2023" align="left" kicker="Chi va salvato" title="La famiglia<br>non si divide" credito="Alluvione in Emilia-Romagna, 2023 · foto Cesare Barillà · CC BY-SA 4.0, via Wikimedia Commons" >}}
...
{{< dossier-scena id="kit" image="/images/dossier/animali-cane-soccorso.webp" alt="Il cane da soccorso e il suo conduttore al termine del turno di ricerca" align="top" kicker="Prepararsi" title="Il kit<br>a quattro zampe" credito="Foto: Sgt. John Healy / U.S. Army · pubblico dominio, via Wikimedia Commons" >}}
...
Aggiungi una foto recente dell'animale (per cercarlo se si perde) e il recapito del veterinario. Il dettaglio completo, voce per voce, è nel nostro [kit per cani, gatti e altri animali](/formazione/kit-calamita/): scaricabile, stampabile, da preparare in un pomeriggio.
...
{{< dossier-chiusura id="fine" titolo="Nessuno escluso, nemmeno loro" cta1="Il kit per gli animali" cta1url="/formazione/kit-calamita/" cta2="Il piano familiare" cta2url="/piano-familiare/" >}}
...
Fallo oggi: [il kit a quattro zampe](/formazione/kit-calamita/) si prepara in un pomeriggio. E in emergenza, per tutti — a due o quattro zampe — chiama il **112**.
{{< /dossier-chiusura >}}
