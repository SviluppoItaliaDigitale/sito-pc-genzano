...
allegati: []
draft: false
# TODO-foto-wikipedia: bash scripts/foto-da-wikipedia.sh "Casco da bicicletta" 2026-04-30-sicurezza-bicicletta-citta-emergenza it

...
{{< foto src="/images/2026-04-30-sicurezza-bicicletta-citta-emergenza-corpo.webp"
...
1. **Sicurezza personale**: le cadute in bicicletta sono un evento sanitario frequente. Prevenirle è prevenzione primaria.
2. **Resilienza urbana**: in una città con più piste ciclabili e meno dipendenza dall'auto, un'emergenza (alluvione, blackout, interruzione stradale) si gestisce meglio.
3. **Mobilità in emergenza**: in alcune situazioni (strade bloccate, carburanti razionati) la bicicletta può essere il mezzo più rapido per spostarsi.

## Le regole di base

Il [Codice della Strada](https://www.mit.gov.it/) equipara la bicicletta a un veicolo. Alcune regole pratiche:
...
1. **Chiama il 112** (NUE Lazio) e fornisci posizione, numero dei feriti e condizioni.
2. **Metti in sicurezza la zona** per evitare altri incidenti.
3. **Non togliere il casco** a un ciclista ferito.
4. **Parla con la persona, tienila sveglia** se è cosciente, senza spostarla.
5. **Attendi i soccorsi** e segui le indicazioni della centrale.

Per le regole generali di primo soccorso trovi un riassunto nell'articolo [Primo soccorso: le cinque regole di base](/comunicazioni/2026-04-29-primo-soccorso-cinque-regole-base/).
