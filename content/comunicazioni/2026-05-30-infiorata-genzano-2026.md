...
- **Persone fragili**: se hai bisogno di un servizio sanitario, **avvicinati alle pattuglie sanitarie a piedi** presenti lungo il percorso o alle **ambulanze stazionate in piazza** ai piedi dell'Infiorata. Per qualsiasi altra necessità rivolgiti agli operatori in divisa istituzionale.

## In caso di emergenza durante l'evento

In caso di **malore, incidente** o qualsiasi emergenza chiama il **112** — il Numero Unico Europeo. La Centrale smista l'intervento al servizio competente (ambulanza, Vigili del Fuoco, Carabinieri, Polizia Locale).
...
## Il sistema di soccorso durante l'Infiorata

L'Infiorata è una manifestazione gestita con **pianificazione operativa pluri-ente**. Sul percorso e nelle aree limitrofe operano, ognuno con il proprio compito:

- **118 e personale sanitario** — pattuglie a piedi lungo via Italo Belardi e ambulanze stazionate in piazza, per la prima assistenza sanitaria.
- **Carabinieri e Polizia Locale** — ordine pubblico, gestione del flusso, viabilità e deviazioni.
- **Vigili del Fuoco** — presidio antincendio, gestione di eventuali emergenze tecniche.
...
- **803&nbsp;555** — Sala Operativa Regionale Lazio (segnalazioni non urgenti di Protezione Civile)

## Sul nostro sito

- [Cosa fare adesso](/cosa-fare-adesso/) — guida rapida alle emergenze
- [Numeri utili](/numeri-utili/) — chi chiamare in ogni situazione
- [Aree di attesa](/aree-attesa/) — dove trovarsi in caso di evacuazione
- [Piano di emergenza comunale](/piano-emergenza/) — la pianificazione del territorio
- [Schede "1 minuto per proteggerti"](/schede-1-minuto/) — sei azioni concrete da stampare
...
Pubblicheremo un **aggiornamento dedicato** non appena saranno disponibili le ordinanze comunali con le indicazioni puntuali su chiusure e parcheggi.
