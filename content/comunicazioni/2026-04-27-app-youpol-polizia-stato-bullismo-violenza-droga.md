...
description: "YouPol è l'app ufficiale della Polizia di Stato per segnalare in modo anonimo o registrato episodi di bullismo, spaccio di droga."
badge: "Informazione"
priorita: "normale"
...
area: "Italia"
allegati:
  - titolo: "Presentazione ufficiale YouPol — Polizia di Stato"
    url: "/manuali/polizia-stato-presentazione-youpol-esserci.pdf"
    dimensione: "2.9 MB"
draft: false
---
...
{{< foto src="/images/youpol/youpol-volantino-polizia-stato.webp"
         alt="Volantino ufficiale dell'app YouPol della Polizia di Stato: l'app che ti mette in contatto diretto con la Polizia di Stato per segnalare bullismo, droga, violenza domestica e altri reati"
         caption="Volantino ufficiale dell'app YouPol. Fonte: Polizia di Stato — campagna #esserciSEMPRE." >}}
...
{{< foto src="/images/youpol/youpol-anonimo-o-registrato.webp"
         alt="Schermata YouPol: scelta tra modalità anonima e registrata. La Polizia di Stato esamina entrambe le segnalazioni nello stesso modo"
         caption="Avvio dell'app YouPol: scelta tra invio anonimo o registrato. Fonte: Polizia di Stato." >}}
...
{{< foto src="/images/youpol/youpol-registrazione-utente.webp"
         alt="Schermata YouPol: registrazione utente in due passaggi — inserimento numero di cellulare con codice di verifica via SMS, poi compilazione dei dati anagrafici"
         caption="Registrazione utente: numero di cellulare con codice di verifica e dati anagrafici. Fonte: Polizia di Stato." >}}

1. Nella **prima schermata** inserisci il tuo numero di cellulare e il codice di verifica che ricevi via SMS.
2. Nella **seconda schermata** compili i dati anagrafici (nome, cognome, data di nascita).
...
{{< foto src="/images/youpol/youpol-schermata-principale.webp"
         alt="Schermata principale di YouPol: menu con localizzazione geografica automatica e pulsante 'Nuovo messaggio' per avviare una segnalazione su bullismo, droga, violenza domestica o altro"
         caption="Schermata principale: localizzazione automatica e pulsante 'Nuovo messaggio'. Fonte: Polizia di Stato." >}}

## Come si compila una segnalazione

Per inviare una segnalazione efficace:

1. **Scegli il tipo** di episodio (bullismo, droga, violenza domestica, altro).
2. **Inserisci una descrizione** dell'accaduto: cosa è successo, quando, chi è coinvolto, da quanto tempo va avanti.
3. **Verifica la posizione** rilevata in automatico dall'app. Puoi modificarla se la segnalazione si riferisce a un luogo diverso da quello in cui ti trovi adesso.
4. Puoi **allegare una foto** scattata in tempo reale o presa dalla galleria del telefono. Una foto rende la segnalazione più chiara e contestualizzata, ma non è obbligatoria.
5. Tocca **"Invia"** per trasmettere alla Polizia di Stato.

{{< foto src="/images/youpol/youpol-come-segnalare.webp"
         alt="Schermata YouPol per inviare una segnalazione: scelta del tipo di episodio, descrizione, posizione modificabile, possibilità di allegare una foto, pulsante Invia"
         caption="Compilazione della segnalazione: tipo, descrizione, posizione, foto opzionale, invio. Fonte: Polizia di Stato." >}}
...
{{< foto src="/images/youpol/youpol-menu-i-tuoi-messaggi.webp"
         alt="Menu di navigazione YouPol e area 'I miei messaggi' con storico delle segnalazioni inviate, possibilità di inviare solleciti e verificare lo stato (solo per utenti registrati)"
         caption="Menu di navigazione e area personale 'I miei messaggi'. Fonte: Polizia di Stato." >}}
