...
- **festeggia** con la famiglia: goditelo intensamente;
- **è solo**: sappi che non sei dimenticato;
- **è in ospedale**: ti mandiamo vicinanza;
- **lavora**: grazie per il servizio che rendi;
- **soffre** per motivi vari: un abbraccio ideale;
- **è lontano** dalla sua casa: portala nel cuore, torna presto;
- **è nato** oggi a Genzano: benvenuto in questa comunità.
