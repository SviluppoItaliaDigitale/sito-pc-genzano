...
image: "/images/2026-05-17-emilia-romagna-2023-alluvione-maggio.webp"
image_alt: "Copertina dell'articolo: Alluvione dell'Emilia-Romagna, maggio 2023, il fango che ha cambiato la cultura del rischio in pianura"
scadenza: ""
...
{{< foto src="/images/2026-05-17-emilia-romagna-2023-aerea-paese-allagato.webp"
         alt="Foto aerea a colori del maggio 2023: vista dall'alto di un paese della pianura emiliano-romagnola completamente sommerso dall'acqua marrone-fango. Si vedono solo i tetti delle case, le strade sono diventate canali, gli alberi emergono come isole. La distesa d'acqua si estende a perdita d'occhio sui campi attorno all'abitato."
         caption="Vista aerea di un paese della pianura emiliano-romagnola sommerso dall'acqua nei giorni dell'alluvione del maggio 2023. L'estensione della distesa d'acqua, che ricopre i campi coltivati intorno all'abitato, restituisce la dimensione storica dell'evento: oltre 540 km² del territorio regionale rimasero allagati per giorni o settimane." >}}
...
{{< foto src="/images/2026-05-17-emilia-romagna-2023-soccorritori-gommone.webp"
         alt="Foto a colori del maggio 2023: una squadra di soccorritori — due vigili del fuoco con tuta gialla fluorescente e uno con tuta arancione di protezione civile — porta a riva un gommone con una persona evacuata, lungo una strada di una città emiliano-romagnola completamente allagata. L'acqua arriva sopra il ginocchio, si vedono cassonetti dei rifiuti sommersi, semafori, una pizzeria con insegna luminosa, alberi e palazzi dei due lati della via."
         caption="Squadre di Vigili del Fuoco e di volontari di Protezione Civile evacuano i residenti dalle case allagate di un Comune emiliano-romagnolo nei giorni dell'alluvione del maggio 2023. Le operazioni di soccorso e salvataggio durarono giorni, con migliaia di persone evacuate via gommone dalle abitazioni isolate." >}}
...
**1. Gli eventi possono essere concatenati.**
Due alluvioni a distanza di **due settimane** sulla stessa zona producono effetti **non additivi ma moltiplicativi**: il terreno saturo dalla prima diventa il moltiplicatore di danno della seconda. I **modelli idraulici** italiani stanno integrando questa dimensione "concatenata" nei loro scenari.

**2. La pianura non è "zona sicura".**
La cultura italiana del rischio idrogeologico era storicamente concentrata sulle **zone montane e collinari** (frane, colate rapide, smottamenti). L'evento del 2023 ha mostrato che le **pianure** italiane — densamente popolate, attraversate da reticoli idraulici complessi (canali, scoli, rogge), spesso al di sotto del livello dei fiumi grazie a opere di **bonifica** secolari — sono **estremamente vulnerabili** quando il sistema di drenaggio collassa. La **Bassa Romagna**, il **Polesine**, la **pianura ferrarese**, la **bassa padana** in generale sono zone dove un'alluvione può fare danni economici incalcolabili.

**3. Il cambiamento climatico rende tutto più frequente.**
Eventi che fino a vent'anni fa erano statisticamente "rari" (tempo di ritorno secolare) sono ora **annuali o sub-annuali** in Italia. Il sistema infrastrutturale italiano — argini, ponti, casse di espansione — è stato dimensionato sulla base di **statistiche storiche** che oggi sottostimano il rischio reale.
...
1. **Conoscere se la propria casa è in zona alluvionabile**: la mappa è pubblica sulla pagina ISPRA "[ItaliaSicura](https://italiasicura.governo.it/)" o sui portali delle Autorità di bacino regionali.
2. **In caso di allerta arancione/rossa**: spostare beni di valore ai piani alti, preparare il [kit di emergenza](/comunicazioni/2026-04-21-kit-emergenza-domestico-guida-pratica/), tenere il telefono carico, non scendere in scantinati o garage.
3. **Durante l'alluvione**: salire ai piani alti, non camminare nell'acqua corrente (anche 30 cm bastano a trascinare via una persona — e in pianura l'acqua è spesso opaca e nasconde tombini aperti, fili scoperti, mobili galleggianti), aspettare i soccorsi.
4. **Dopo l'alluvione**: non rientrare prima del nullaosta delle autorità, non bere l'acqua del rubinetto fino a quando non viene certificata sicura, vaccinarsi contro il tetano se ci si ferisce.

Il [piano familiare di emergenza](/piano-familiare/) è uno strumento concreto per prepararsi a scenari come questo.
