...
description: "Come funziona il sistema italiano di prevenzione delle ondate di calore: allerta HHWWS, numero 1500, anagrafi dei fragili, sorveglianza attiva."
badge: "Informazione"
priorita: "normale"
...
|---|---|
| **0** | Nessun rischio |
| **1** | Condizioni meteo che **precedono** un'ondata di calore |
| **2** | Ondata di calore **in corso** con effetti sanitari |
| **3** | Ondata di calore **prolungata** con effetti sul sistema sanitario |
