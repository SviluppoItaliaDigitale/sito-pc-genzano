...
Bilancio finale: **14 morti**, **decine di dispersi mai ritrovati** (i corpi furono probabilmente trascinati al mare dalle colate), oltre **mille senzatetto**, danni stimati in **circa 250 miliardi di lire** dell'epoca.
...
## La risposta del sistema italiano
...
- Il rafforzamento della **previsione meteorologica idrologica** del Centro Funzionale Centrale del DPC

## Cosa ci insegna oggi

Versilia 1996 è il caso scuola dei **rischi idrogeologici legati a piogge intense in zone montane**. Tre lezioni operative:

1. **Le aree a forte pendenza con bacini piccoli sono particolarmente fragili.** Il tempo di concentrazione dell'acqua è breve, l'allerta arriva spesso quando l'evento è già in corso. Per questo l'**autoprotezione del cittadino** in caso di pioggia intensa diventa fondamentale: non sostare lungo torrenti, non attraversare ponti, allontanarsi dai versanti instabili.
...
- **Sottopassaggi stradali** e **fossi tombinati** che possono allagarsi rapidamente in caso di temporali intensi
- **Piazzale Della Vittoria, via Italo Belardi, area di San Gennaro**: punti storicamente sensibili agli allagamenti urbani

In caso di **allerta arancione o rossa per rischio idrogeologico**, le indicazioni sono nella sezione [Cosa Fare Adesso](/cosa-fare-adesso/) e nella pagina [Allerte Meteo](/allerte-meteo/).
