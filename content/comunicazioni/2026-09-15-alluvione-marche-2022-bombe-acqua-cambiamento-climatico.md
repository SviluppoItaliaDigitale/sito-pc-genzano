...
image: "/images/2026-09-15-alluvione-marche-2022-bombe-acqua-cambiamento-climatico.webp"
image_alt: "Copertina dell'articolo: Alluvione delle Marche, 15-16 settembre 2022, la notte delle bombe d'acqua sui Monti del Catria"
scadenza: ""
area: "Italia · Marche · provincia di Ancona e Pesaro-Urbino"
allegati: []
...
{{< foto src="/images/2026-evento-marche-2022-senigallia-acqua.webp"
         alt="Immagine satellitare dell'Italia quasi interamente coperta da un esteso sistema nuvoloso, con addensamenti più densi sul versante adriatico e sul Tirreno; sullo sfondo si distinguono Sardegna e Sicilia parzialmente libere dalle nubi"
         caption="Il sistema perturbato che nella notte tra il 15 e il 16 settembre 2022 scaricò sulle Marche centro-settentrionali oltre 400 mm di pioggia in poche ore nelle vallate del Misa e del Nevola: 13 morti. La 'bomba d'acqua' diventa un'espressione meteorologica entrata nel linguaggio comune." >}}
...
L'alluvione del 15 settembre 2022 è il prototipo del fenomeno meteorologico chiamato "**bomba d'acqua**" o, più correttamente, **rovescio temporalesco autorigenerante**. È un sistema di temporali che, alimentato da una convergenza di umidità e calore, **resta fermo** per diverse ore sopra la stessa zona. Scarica quantità di pioggia che normalmente sarebbero distribuite su giorni o settimane.

Le condizioni di quel 15 settembre erano:

- **Aria caldo-umida** richiamata sull'Appennino marchigiano da una saccatura mediterranea.
- **Mare Adriatico ancora caldo** dopo l'estate (oltre 26°C), che ha fornito energia ai temporali.
- **Convergenza al suolo** che ha forzato la massa d'aria a salire e condensare in modo intenso.
- **Persistenza del sistema** per quasi cinque ore sopra la stessa zona.

Il risultato è stato un evento **statisticamente raro** — definito spesso "tempo di ritorno superiore a 200 anni" per quelle aree — ma sempre meno raro nella **frequenza con cui si verificano in Italia** eventi di questo tipo. È uno degli effetti documentati dell'**aumento delle temperature medie globali**: l'atmosfera più calda contiene più vapore acqueo, e quando le condizioni dinamiche favoriscono la condensazione, la pioggia esce in quantità mai viste.

## La risposta operativa

I primi soccorsi furono attivati nelle ore della notte stessa. **Vigili del fuoco** delle squadre territoriali, **118**, **Carabinieri**, **Croce Rossa**, **Protezione Civile regionale**, **volontariato organizzato** delle Marche e delle regioni limitrofe, **Forze armate** in supporto. Una **colonna mobile nazionale** del Dipartimento di Protezione Civile fu schierata nei giorni immediatamente successivi.
...
L'evento del 15 settembre 2022 ha riacceso il dibattito su due aspetti del sistema italiano di protezione civile:
...
Negli anni successivi all'alluvione del 2022:
...
Per chi vive in **zone collinari, lungo corsi d'acqua minori, in aree urbane con drenaggio insufficiente**, le regole base sono:

1. **Conoscere i livelli di allerta**: verde, giallo, arancione, rosso. Si trovano sul portale **del Centro Funzionale Regionale** della propria Regione (per il Lazio: [protezionecivile.regione.lazio.it](https://protezionecivile.regione.lazio.it/)).
2. **Non sottovalutare l'allerta gialla**: non è "gialla" che vuol dire "non succede niente". Significa che è **possibile** un fenomeno significativo localizzato. È il livello con cui sono accadute molte tragedie (incluso il 2022 marchigiano).
3. **Tenere il cellulare attivo e con la suoneria alta** durante temporali notturni. **IT-alert** può svegliarvi.
4. **In caso di pioggia molto forte**: mai entrare in scantinati o garage allagati, mai attraversare strade allagate (ne abbiamo parlato in [Sarno 1998](/comunicazioni/2026-05-05-sarno-frana-1998-rischio-idrogeologico-italia/)), salire ai piani alti dell'edificio.
5. **Pulizia dei fossi vicini a casa propria**: è una responsabilità anche dei privati. Un fosso libero salva vite a valle.

## Genzano e il rischio "bomba d'acqua"

I **Castelli Romani**, e in particolare Genzano, sono **direttamente esposti** allo stesso tipo di rischio che si è manifestato nelle Marche: rovesci temporaleschi convettivi di intensità eccezionale, generati dal calore residuo del **mare Tirreno** in tarda estate e inizio autunno. Anche ai Castelli Romani i temporali di fine estate producono ogni anno allagamenti e smottamenti locali, come nella [giornata del 10 settembre 2026](/comunicazioni/2026-09-11-pioggia-alberi-tombini-voragine-otto-interventi/).

Il **Piano di Emergenza Comunale** di Genzano di Roma, consultabile nella pagina [Piano di emergenza](/piano-emergenza/), descrive gli scenari di rischio idrogeologico del territorio e i comportamenti raccomandati. Vedi anche [Rischio idraulico urbano a Genzano](/comunicazioni/2026-09-15-rischio-idraulico-urbano-genzano/) e [Pulizia fossi e caditoie](/comunicazioni/2026-08-28-pulizia-fossi-caditoie-prevenzione-autunno/).

## In ricordo

Le **13 vittime** dell'alluvione marchigiana del 15-16 settembre 2022 sono ricordate ogni anno con cerimonie nei Comuni colpiti. La memoria delle Marche si intreccia, in questi anni, con quella di altre alluvioni recenti — l'**Emilia-Romagna del maggio 2023**, le **Marche di nuovo nel 2024**, la **Toscana e l'Emilia del 2025** — disegnando una mappa preoccupante di **eventi estremi sempre più frequenti** sul territorio italiano.

Quattro anni dopo, l'Italia continua a fare i conti con la propria fragilità idrogeologica e con il fatto che il **clima sta cambiando più velocemente** di quanto le infrastrutture e i piani di emergenza riescano ad adattarsi. Il volontariato di protezione civile è uno degli strumenti che il Paese si è dato per **ridurre il divario** fra rischio e capacità di risposta. Ogni anno, ogni volontario formato, ogni Piano Familiare compilato è un mattone di questa risposta.

## Per approfondire (fonti istituzionali)

- [Dipartimento di Protezione Civile — Alluvione Marche settembre 2022](https://www.protezionecivile.gov.it/)
- [Regione Marche — Centro Funzionale Multirischi](https://www.protezionecivile.marche.it/)
- [ISPRA — Rapporto su dissesto idrogeologico in Italia](https://www.isprambiente.gov.it/)
- [IT-alert — Sistema nazionale di allarme pubblico](https://www.it-alert.gov.it/)
- [CNR-IRPI Polaris — Eventi alluvionali italiani](https://polaris.irpi.cnr.it/)
