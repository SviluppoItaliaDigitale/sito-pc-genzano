...
description: "Una bomba d'acqua di 500 mm in 6 ore colpì Genova: il rio Fereggiano, tombato sotto la città, esplose dalla sede stradale."
badge: "Comunicazione"
priorita: "normale"
...
- **Progetti di scolmatori e raddoppi** per i rii più critici (a Genova, lo scolmatore del Bisagno-Fereggiano è stato realizzato negli anni successivi)

## Cosa ci insegna oggi

Tre lezioni operative dalla tragedia di Genova:

1. **Le città storiche italiane hanno rii nascosti che vanno mappati e gestiti.** Non basta sapere dove passa il fiume principale: bisogna conoscere anche i corsi d'acqua minori tombati, perché in caso di piena improvvisa **possono uccidere proprio loro**.

2. **Le bombe d'acqua sono il nuovo standard climatico, non l'eccezione.** Eventi che il 1990 considerava "millenari" oggi si ripetono ogni 5-10 anni. La **pianificazione di Protezione Civile** deve aggiornarsi a questa realtà.
...
- **Non attraversare** strade allagate, anche se sembrano poca acqua: il flusso rapido può trascinare via
...
- [Centro Funzionale Regione Lazio](https://protezionecivile.regione.lazio.it/)
- Voce Wikipedia: [Alluvione di Genova del 4 novembre 2011](https://it.wikipedia.org/wiki/Alluvione_di_Genova_del_4_novembre_2011)
