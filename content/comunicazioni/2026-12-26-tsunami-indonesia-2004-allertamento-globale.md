---
title: "Tsunami dell'Oceano Indiano, 26 dicembre 2004: la più grande operazione di soccorso internazionale"
date: 2026-12-26
description: "Un terremoto di magnitudo 9.1 al largo di Sumatra generò un'onda anomala che colpì 14 Paesi: oltre 230.000 morti. La più grande operazione di soccorso internazionale del XXI secolo. La nascita del sistema globale di allertamento tsunami."
badge: "Comunicazione"
priorita: "normale"
...
- L'Italia, attraverso il **Dipartimento di Protezione Civile e l'INGV**, partecipa al **NEAMTWS** (Sistema di Allerta Tsunami per Mediterraneo e Atlantico Nord-Orientale) attivo dal 2012

## Cosa ci insegna oggi

Il 2004 ha consolidato tre principi della Protezione Civile contemporanea:

1. **Il rischio si gestisce a scala globale.** I fenomeni naturali non si fermano ai confini nazionali. La cooperazione internazionale (sistemi di monitoraggio condivisi, scambio dati in tempo reale, formazione coordinata) è oggi una componente essenziale della prevenzione.

2. **L'allerta funziona solo se la popolazione sa cosa fare.** A Sumatra una bambina inglese di 10 anni, **Tilly Smith**, riconobbe i segnali di tsunami imparati a scuola (il mare che si ritira, le onde di mezzo) e fece evacuare la spiaggia di Phuket dove era in vacanza con i genitori. Ha probabilmente salvato un centinaio di persone. La sua storia è un riferimento globale per l'**educazione al rischio**.

3. **Anche il Mediterraneo è a rischio tsunami.** Eventi storici (Messina 1908, Maremoto del Tirreno 1783) ne sono testimonianza. Dal 2017 in Italia esiste il **CAT (Centro Allerta Tsunami)** dell'INGV, che invia avvisi al Dipartimento di Protezione Civile per la diramazione alla popolazione costiera.

## A Genzano

Genzano è entroterra, 435 metri sul livello del mare. Il rischio tsunami non ci riguarda direttamente. Ma la lezione di Sumatra è universale: **l'educazione al rischio salva le vite**. Per questo investiamo nei [kit didattici per le scuole](/formazione/) di ogni livello, perché bambini e ragazzi imparino a riconoscere i segnali dei rischi naturali e a comportarsi di conseguenza.

## Per saperne di più

- [Centro Allerta Tsunami — INGV](https://cat.ingv.it/)
- [IOC-UNESCO — Tsunami Warning Systems](https://www.ioc-tsunami.org/)
- Voce Wikipedia: [Maremoto e terremoto dell'Oceano Indiano del 2004](https://it.wikipedia.org/wiki/Maremoto_e_terremoto_dell%27Oceano_Indiano_del_2004)
