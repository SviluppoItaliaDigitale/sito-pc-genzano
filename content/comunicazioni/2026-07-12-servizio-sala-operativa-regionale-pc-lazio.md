...
image: "/images/2026-07-12-servizio-sala-operativa-regionale-pc-lazio.webp"
image_alt: "Cover dell'articolo: La nostra squadra in servizio alla Sala Operativa regionale della Protezione Civile"
scadenza: ""
area: "Roma"
allegati: []
draft: false
...
La Sala Operativa è il punto di ascolto e coordinamento della Protezione Civile della Regione Lazio. Riceve le segnalazioni dal territorio e le smista alle strutture competenti. Tiene inoltre i contatti con i Comuni, le organizzazioni di volontariato e le altre componenti del sistema. Risponde anche al **numero verde 803 555**, dedicato alle segnalazioni di protezione civile **non urgenti**.

{{< foto src="/images/2026-07-12-sala-operativa-lazio-ingresso.webp"
         alt="Parete d'ingresso della Sala Operativa con il logo della Protezione Civile Regione Lazio, il logo della Regione Lazio e la scritta Sala Operativa"
         caption="L'ingresso della Sala Operativa della Protezione Civile della Regione Lazio. Foto: Gruppo Comunale Volontari di Protezione Civile di Genzano di Roma." >}}

Ricorda la regola di sempre: **per le emergenze si chiama il 112**, il Numero Unico Europeo. Il numero verde della Sala Operativa regionale serve per le comunicazioni e le segnalazioni che non richiedono un soccorso immediato. Trovi il quadro completo nella nostra pagina dei [numeri utili](/numeri-utili/).

## Il turno dei nostri volontari
...
## Vuoi far parte anche tu della squadra?

Il servizio in Sala Operativa è una delle tante forme del volontariato di protezione civile. Accanto ai turni sul territorio ci sono attività di ascolto, comunicazione e supporto tecnico. Se vuoi metterti in gioco, scopri [come diventare volontario](/diventa-volontario/) del nostro Gruppo.
