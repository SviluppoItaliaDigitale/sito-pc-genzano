---
title: "Educazione civica e protezione civile"
description: "Mappa dei materiali del Gruppo sui nuclei del D.M. 183/2024, sull'Agenda 2030 e sui percorsi di protezione civile per la scuola."
date: 2026-05-01
draft: false
type: "page"
layout: "single"
...
- [Costituzione e protezione civile — Primaria](/formazione/schede-stampabili/costituzione-pc-primaria/)
- [Costituzione e protezione civile — Secondaria I grado](/formazione/schede-stampabili/costituzione-pc-secondaria/)
- [Codice della protezione civile — Secondaria II grado](/formazione/schede-stampabili/codice-pc-secondaria2/)
...
## Suddivisione interdisciplinare
...
| Matematica | Dati, percentuali, tempi di evacuazione, statistiche | Problemi reali e tabelle |
| Tecnologia | Planimetrie, IT-alert, mappe digitali, procedure | Audit del piano, mappe GIS |
| Educazione fisica | Evacuazione, primo soccorso, comportamenti sicuri | Prove guidate e simulazioni |
| Arte | Pittogrammi, cartelli, mappe, comunicazione visiva | Cartelli e pittogrammi |
| Inglese | Lessico di emergenza e protezione civile europea | English for Civil Protection |
| Diritto | Costituzione, D.Lgs. 1/2018, volontariato, sicurezza | Normativa e cittadinanza |

## Valutazione

La valutazione deve misurare competenze e comportamenti, non la paura o il coraggio personale.

Indicatori utili:

- conosce il ruolo del 112;
- distingue allerta, emergenza e fonte ufficiale;
- riconosce i principali rischi del territorio;
- sa indicare comportamenti corretti di autoprotezione;
- collabora in modo responsabile;
- comprende il ruolo delle istituzioni e del volontariato;
- sa comunicare un'informazione di emergenza in modo chiaro.

Rubriche disponibili:

- [Rubrica valutativa — Infanzia](/formazione/schede-stampabili/rubrica-valutativa-infanzia/)
- [Rubrica valutativa — Primaria](/formazione/schede-stampabili/rubrica-valutativa-primaria/)
- [Rubrica valutativa — Secondaria I grado](/formazione/schede-stampabili/rubrica-valutativa-secondaria/)
- [Rubrica valutativa — Secondaria II grado](/formazione/schede-stampabili/rubrica-valutativa-secondaria2/)

## Esempio di articolazione annuale

Un percorso di 33 ore può essere costruito così:

| Periodo | Ore | Tema |
|---|---:|---|
| Settembre | 3 | Che cos'è la protezione civile e quando si chiama il 112 |
| Ottobre | 4 | Rischio idrogeologico e territorio dei Castelli Romani |
...
Sono possibili anche percorsi PCTO per la secondaria di secondo grado, da definire con dirigente scolastico, tutor, coperture assicurative, formazione sulla sicurezza e progetto formativo.

Aree possibili:

- mappatura del territorio;
- comunicazione del rischio;
- supporto a esercitazioni e campagne informative;
- documentazione foto e video;
- conoscenza di mezzi e attrezzature sotto supervisione.

L'attivazione di un PCTO è sempre subordinata alla valutazione del Coordinatore e del Consiglio Direttivo del Gruppo, alla disponibilità operativa e alle procedure dell'istituto scolastico.

## Stato dei materiali

I materiali del Gruppo sono prodotti volontariamente e sono liberamente utilizzabili dalle scuole. Non sono testi scolastici ministeriali, non sostituiscono i libri adottati e non costituiscono documenti ufficialmente validati dal MIM o da altri enti.

Sono progettati per essere coerenti con normativa scolastica, competenze chiave europee, Agenda 2030 e obiettivi di educazione civica. La scelta finale sull'uso in classe spetta al docente, in coerenza con il PTOF e con la programmazione del consiglio di classe.

## Contatti

Per proporre un'attività o chiedere informazioni scrivi a [segreteria@protezionecivilegenzano.it](mailto:segreteria@protezionecivilegenzano.it), indicando scuola, classe, periodo richiesto e tema preferito.
...
- [Quadro normativo per la scuola](/formazione/quadro-normativo-scuola/)
