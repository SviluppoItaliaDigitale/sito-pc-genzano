...
- **Moduli** messaggio (vedi [Capitolo 6 Manuale da Campo](/formazione/manuale-campo/moduli-radio/))
...
| Categoria | Elemento |
|---|---|
| **RTX VHF** | Yaesu FTM-300DE o analogo, 50 W, dual-band VHF/UHF |
| **RTX HF** | Kenwood TS-480HX o analogo, 100 W, con accordatore |
| **Antenna VHF** | Diamond X-50 o yagi 5 elementi, palo telescopico 6 m |
| **Antenna HF** | Dipolo 40/80 m o EndFed multibanda, palo 10 m |
| **Alimentazione** | Batteria AGM 100 Ah + pannello solare 50 W, generatore 2 kVA |
| **Cavi** | Coassiali RG-213 da 20 m, PowerPole a profusione |
| **Accessori** | Cuffia boom, pedale PTT, microfono desk, interfaccia digitale USB |
| **Documenti** | Moduli messaggio, registro, NATO, frequenze, check-list |

## Leggi anche

- [Capitolo 4 — Gestione dei messaggi e controllo di maglia](/formazione/radiocomunicazioni-emergenza/gestione-messaggi/)
- [Capitolo 6 — Sicurezza e sopravvivenza in emergenza](/formazione/radiocomunicazioni-emergenza/sicurezza-sopravvivenza/)
- [Manuale da Campo — Capitolo 3 — Schede tecniche](/formazione/manuale-campo/schede-tecniche/)
