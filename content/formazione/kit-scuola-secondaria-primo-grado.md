...
- Conoscere il Sistema Nazionale di Protezione Civile e i suoi principi fondamentali
- Comprendere i rischi specifici del territorio di Genzano e dei Castelli Romani
- Saper leggere e interpretare un bollettino di allerta meteo
- Conoscere i comportamenti di autoprotezione per ogni tipo di rischio
- Realizzare un piano di emergenza familiare completo
- Sviluppare il senso di responsabilità civica e il valore della prevenzione

### Collegamento con le discipline

| Disciplina | Argomenti collegati |
|---|---|
| **Scienze** | Terremoti, vulcani, ciclo dell'acqua, meteorologia, geologia |
| **Geografia** | Territorio, carte tematiche, rischio idrogeologico, cambiamenti climatici |
| **Ed. civica** | Cittadinanza attiva, volontariato, istituzioni, diritti e doveri |
| **Tecnologia** | Sistemi di allertamento, app di emergenza, strumenti di monitoraggio |
| **Italiano** | Comunicazione del rischio, analisi di testi informativi istituzionali |
