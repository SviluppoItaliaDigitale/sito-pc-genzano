...
description: "Guida operativa per il volontario PC in emergenza: struttura, scouting, funzioni tecniche e di servizio, schede tecniche. Per il Gruppo di Genzano di Roma."
---
...
Il manuale non sostituisce la **formazione di base regionale** del volontario (art. 37 D.Lgs. 1/2018), né il **Piano Comunale di Protezione Civile** di Genzano di Roma (art. 12 D.Lgs. 1/2018). Serve come **supporto rapido sul campo** e come traccia per esercitazioni e addestramento.

## A chi è rivolto

- **Volontari iscritti** al Gruppo Comunale Volontari PC Genzano
- **Operatori di funzioni di supporto** del Centro Operativo Comunale (COC)
- **Formatori** che organizzano corsi o esercitazioni
- **Volontari di altre organizzazioni** attive sul territorio dei Castelli Romani

## Struttura del manuale

| Capitolo | Contenuto |
|---|---|
| [1. Struttura organizzativa e catena di comando](/formazione/manuale-campo/struttura-organizzativa/) | Inquadramento istituzionale dal livello nazionale al comunale, centri di coordinamento, funzioni di supporto (metodo Augustus aggiornato) |
| [2. Scouting e valutazione iniziale](/formazione/manuale-campo/scouting/) | Nucleo di valutazione, azioni prima/durante/dopo l'evento, **7 check-list operative** (kit personale, squadre, informazioni, attivazione colonna mobile, area accoglienza, progettazione, area esterna) |
...
Il manuale si fonda su cinque principi operativi, validi in qualsiasi emergenza:

1. **Niente intervento senza attivazione formale.** Il volontario non agisce di propria iniziativa. Ogni missione parte da una **nota di attivazione** del Sindaco, della Prefettura di Roma, della Regione Lazio o del Dipartimento Nazionale (art. 36 D.Lgs. 1/2018). Solo un'attivazione ufficiale garantisce **assicurazione**, **copertura del posto di lavoro**, **rimborso spese**.
2. **Prima la sicurezza del volontario.** Nessun soccorso è così urgente da giustificare un rischio ingiustificato per chi soccorre. I **Dispositivi di Protezione Individuale** non sono opzionali.
3. **Tracciabilità totale.** Ogni attività va documentata: chi, cosa, dove, quando, con quali mezzi. La **segreteria di campo** è il cuore della tracciabilità.
4. **Comunicazione chiara e sobria.** In emergenza si usano parole semplici, frasi brevi, radio disciplinata. I rumori e le ambiguità costano tempo.
5. **Rispetto per la popolazione colpita.** Chi riceve assistenza è già in una condizione di vulnerabilità. Il linguaggio, il tono, lo sguardo contano quanto il pasto caldo e la branda pulita.
...
- **integrazione nei moduli regionali** quando attivati in emergenze di rilievo regionale (Tipo B)
- **supporto alle colonne mobili nazionali** nelle emergenze di rilievo nazionale (Tipo C)

## Aggiornamenti

Il manuale è un **documento vivo**: ogni esercitazione, ogni missione reale, ogni evoluzione normativa è occasione di revisione. Le segnalazioni di errori, lacune o suggerimenti si raccolgono tramite [il modulo contatti](/contatti/).
