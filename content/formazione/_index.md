...
description: "Corsi per volontari, materiali per le scuole, giochi educativi e risorse sulla protezione civile per cittadini, docenti e famiglie."
layout: "single"
toc: true
tts: true
...
La formazione aiuta volontari, cittadini e scuole a riconoscere i rischi e ad agire con più sicurezza. In questa pagina trovi i percorsi principali e i materiali più utili.

## Da dove cominciare

Scegli il percorso più adatto al tuo bisogno.

<div class="row g-3 mb-4">
<div class="col-md-6 col-lg-4"><div class="card h-100 shadow-sm"><div class="card-body"><h2 class="h5">Sono un cittadino</h2><p>Leggi le azioni di autoprotezione per terremoto, alluvione, incendio, temporali, vento, caldo, blackout ed evacuazione.</p><a href="/formazione/cosa-fare-in-caso-di/" class="btn btn-primary">Apri la guida per il cittadino</a></div></div></div>
...
Ogni nuovo volontario segue un corso base prima dell'impiego operativo. Il percorso introduce:

- Sistema nazionale di protezione civile;
- rischi del territorio di Genzano di Roma;
- Piano di Emergenza Comunale e procedure operative;
- sicurezza personale e uso delle dotazioni;
- nozioni di primo soccorso;
- comunicazioni radio in emergenza;
- comportamento corretto in scenario.

I volontari già operativi partecipano ad aggiornamenti ed esercitazioni periodiche, tra cui:

- esercitazioni pratiche sul territorio;
- corsi specialistici, per esempio AIB, rischio idrogeologico e TLC;
- addestramento su mezzi, attrezzature e procedure;
- formazione dei divulgatori per gli incontri nelle scuole;
- simulazioni coordinate con il sistema regionale;
- incontri con altri enti del sistema di protezione civile.
...
|---|---|---|
| [Scuola dell'infanzia](kit-scuola-infanzia/) | 3-6 anni | Storie, giochi, regola della tartaruga, numero 112 |
| [Scuola primaria](kit-scuola-primaria/) | 6-11 anni | Rischi del territorio, comportamenti corretti, piano familiare |
...
## Inclusione e bisogni specifici

Alcune persone hanno bisogno di indicazioni più semplici, tempi più lunghi o materiali adattati.

- [Kit per fragilità e bisogni specifici](/formazione/kit-fragilita-vulnerabilita/) — orientamento rapido ai materiali più adatti.
- [Facile da leggere](/facile-da-leggere/) — istruzioni essenziali con frasi brevi.
- [Abili a proteggere](/abili-a-proteggere/) — attività educative accessibili ispirate al programma nazionale del Dipartimento della Protezione Civile.
- [Easy-to-Read per le scuole](/formazione/easy-to-read-scuola/) — schede semplificate con pittogrammi.
...
| Area | Contenuto principale | Link |
|---|---|---|
| Psicologia dell'emergenza | Ansia, paura, primo soccorso psicologico, scuola e famiglia | [Apri l'area](/formazione/psicologia-emergenza/) |
| Primo soccorso e RCP | Arresto cardiaco, DAE, disostruzione, emorragie, ustioni | [Apri l'area](/formazione/primo-soccorso/) |
| Manuale da campo | Catena di comando, logistica, comunicazioni, kit personale, aree e messaggi radio | [Apri il manuale](/formazione/manuale-campo/) |
| Rischio incendio | Combustione, classi di fuoco, estinguenti e procedure di emergenza | [Apri l'area](/formazione/rischio-incendio/) |
| Radiocomunicazioni di emergenza | Fonetica NATO, reti radio, gestione messaggi, controllo di maglia ed equipaggiamento | [Apri l'area](/formazione/radiocomunicazioni-emergenza/) |
...
- [Quiz di Protezione Civile](/quizpc/) — verifica le tue conoscenze.
...
- [Corso di formazione base per nuovi volontari](/comunicazioni/2025-03-10-formazione-base/)
