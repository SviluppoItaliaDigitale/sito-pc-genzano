...
description: "Schede operative pronte da stampare A4 per assistere bambini, anziani e ospiti di strutture sanitarie durante e dopo una calamità. Basate su protocolli evidence-based PFA, HelpAge, Sphere Standards."
layout: "single"
---

In una calamità (terremoto, alluvione, incendio, evacuazione) ci sono persone particolarmente vulnerabili che hanno bisogno di **strumenti operativi immediati**: bambini in stress da imprevisto, anziani disorientati, ospiti di RSA da evacuare. Per ognuna di queste categorie il Gruppo Comunale Volontari ha preparato un **kit di schede stampabili** in formato A4, basato su protocolli internazionali (NCTSN, IFRC, WHO, Sphere Standards, HelpAge).
...
1. **Identifica la categoria** della persona (bambino/anziano in casa/ospite RSA).
