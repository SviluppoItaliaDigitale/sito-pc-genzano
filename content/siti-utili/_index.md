...
description: "Link a siti istituzionali, portali operativi, fonti tecniche e risorse educative utili per protezione civile, prevenzione e sicurezza del cittadino."
layout: "single"
aliases:
  - /sitiutili.html
  - /sitiutili/
...
<p class="mb-0"><i class="bi bi-exclamation-triangle me-2" aria-hidden="true"></i>In caso di emergenza non usare questa pagina per chiedere aiuto: chiama il <strong>112</strong>.</p>
</div>
...
- [Dipartimento della Protezione Civile](https://www.protezionecivile.gov.it/it/) — riferimento nazionale per attività, campagne informative, norme e comunicazioni ufficiali.
...
- [Normattiva](https://www.normattiva.it/) — consultazione gratuita della normativa italiana.
- [Io non rischio](https://www.iononrischio.it/) — campagna nazionale sulle buone pratiche di prevenzione.
- [Abili a proteggere](https://www.abiliaproteggere.net/) — portale dedicato a disabilità, fragilità ed emergenze.
...
- [Parco Regionale dei Castelli Romani](https://www.parcocastelliromani.it/s/92003020580/) — informazioni sul territorio e sulla tutela ambientale.
...
- [App IO](https://io.italia.it/) — app dei servizi pubblici.
...
Le fonti seguenti sono utili per comunicazione pubblica, accessibilità e gestione delle informazioni in emergenza.

### Riferimenti italiani

- [Linee guida di design per i servizi web della PA](https://designers.italia.it/normativa/linee-guida-di-design/) — riferimento AGID e Designers Italia.
- [Portale Rischi del Dipartimento della Protezione Civile](https://rischi.protezionecivile.gov.it/it/) — schede nazionali sui principali rischi.
- [Io non rischio](https://www.iononrischio.it/) — materiali divulgativi su rischio sismico, alluvione, vulcano, maremoto e incendio boschivo.
...
- [ISPRA — IdroGEO](https://idrogeo.isprambiente.it/) — cartografia su frane e alluvioni.
- [INGV — Terremoti](https://terremoti.ingv.it/) — eventi sismici in tempo reale.
- [WCAG 2.2 — W3C](https://www.w3.org/TR/WCAG22/) — linee guida internazionali per l'accessibilità web.
- [ISO 22329:2021](https://www.iso.org/standard/50064.html) — standard internazionale sull'uso dei social media nelle emergenze. Norma a pagamento.

### Documenti operativi archiviati sul sito

- [CNA — Best Practices in Social Media Crisis Communications for State and Local Emergency Management Agencies (2023)](/manuali/cna-best-practices-social-media-crisis-2023.pdf) — white paper su social media e crisi.
- [DHS/FEMA SAVER — Innovative Uses of Social Media in Emergency Management](/manuali/fema-saver-innovative-uses-social-media-emergency-management.pdf) — casi studio sull'uso dei social in emergenza.

## Agenzie di stampa e media

- [ANSA Lazio](https://www.ansa.it/lazio/) — notizie sulla Regione Lazio.
- [ANSA](https://www.ansa.it/) — notizie nazionali e internazionali.
- [Rai News TGR Lazio](https://www.rainews.it/tgr/lazio) — notizie e approfondimenti regionali.
- [Euronews](https://it.euronews.com/) — informazione internazionale.
- [Local Team](https://www.localteam.it/) — agenzia di stampa specializzata in cronaca locale.
...
- [Quiz di Protezione Civile](/quizpc/) — quiz interattivo sulle conoscenze di base.
- [Giochi della sicurezza](/giochi/) — giochi educativi per infanzia, primaria e ragazzi.
