...
description: "Come entrare nel Gruppo Comunale di Protezione Civile di Genzano di Roma: requisiti, formazione, impegno richiesto e contatti."
layout: "single"
toc: true
aliases:
...
<h2 class="h4 text-primary"><i class="bi bi-heart-fill me-2" aria-hidden="true"></i>In breve</h2>
<ul class="mb-0">
<li>l'iscrizione è gratuita;</li>
<li>la formazione di base è obbligatoria;</li>
<li>l'impegno ordinario è di circa 16 ore al mese;</li>
<li>le attività si svolgono sotto coordinamento delle autorità competenti;</li>
<li>la piena operatività sul campo è prevista dal compimento dei 18 anni.</li>
</ul>
</div>
</div>
...
<div class="col-md-7">
<h2 class="h4">Scarica la locandina</h2>
<p>Puoi stampare la locandina di reclutamento e condividerla in luoghi aperti al pubblico, nel rispetto delle autorizzazioni necessarie.</p>
<p class="mb-0">
<a href="/manuali/locandine/locandina-diventa-volontario.pdf" target="_blank" rel="noopener" class="btn btn-primary">
...
4. procedure operative del Gruppo;
...
<i class="bi bi-file-earmark-pdf me-2" aria-hidden="true"></i>Scarica la domanda di ammissione in PDF
</a>

Insieme alla domanda compilata e firmata, porta in sede:
...
- [Formazione regionale: le lezioni in Sala Operativa Lazio](/comunicazioni/2026-04-19-formazione-regionale-sala-operativa-lazio-nuovi-volontari/)
- [Attivazione squadre di primavera: il calendario operativo](/comunicazioni/2026-04-10-attivazione-squadre-primavera-calendario-operativo/)
...
<h2 class="h5 text-primary">Vuoi saperne di più?</h2>
<p class="mb-3">Scrivici o chiamaci per fissare un colloquio conoscitivo.</p>
<a href="mailto:segreteria@protezionecivilegenzano.it" class="btn btn-primary btn-lg"><i class="bi bi-envelope me-2" aria-hidden="true"></i>Scrivi alla segreteria</a>
