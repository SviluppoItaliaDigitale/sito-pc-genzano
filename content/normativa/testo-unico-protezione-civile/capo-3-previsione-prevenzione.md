...
|---|---|---|
| **Nazionale** | Presidenza del Consiglio – DPC | Scenari di rilievo nazionale, direttive generali, piani di settore |
| **Regionale** | Regioni | Zone di allerta, organizzazione regionale, scenari regionali, assetto del volontariato |
| **Comunale (o di ambito)** | Comuni | Scenari locali, risorse, procedure operative, cartografia, COC, aree di emergenza |
...
Sono piani **vivi**: vanno **aggiornati** quando cambiano le condizioni rilevanti, **testati** con esercitazioni periodiche e **comunicati** alla popolazione. Il Piano Comunale di Genzano di Roma è disponibile nella sezione [Piano di Emergenza](/piano-emergenza/) del sito.
...
| **Non strutturale** | Pianificazione, informazione e formazione della popolazione, esercitazioni, regole di edificazione, cartografia del rischio |
