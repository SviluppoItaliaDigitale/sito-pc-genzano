---
title: "Il Servizio Nazionale della Protezione Civile"
description: "Chi compone il sistema di protezione civile, come si dividono i compiti tra Stato, Regioni e Comuni, e perché il Sindaco è la prima autorità di protezione civile."
layout: "single"
toc: true
image: ""
date: 2026-05-29
...
<p class="mb-0"><i class="bi bi-info-circle me-2" aria-hidden="true"></i><strong>Una guida divulgativa.</strong> Questa pagina spiega come è organizzato il sistema a scopo informativo. Il Gruppo Comunale Volontari di Protezione Civile di Genzano di Roma <strong>non parla a nome</strong> del Dipartimento della Protezione Civile né della Regione Lazio. In emergenza il riferimento resta sempre il <strong>numero unico 112</strong> e i canali ufficiali.</p>
</div>
...
| Livello | Chi | Ruolo essenziale |
|---|---|---|
| Comunale | Sindaco, Comune, Centro Operativo Comunale (COC) | Prima risposta, informazione e assistenza alla popolazione |
...
- [Soccorso e gestione dell'emergenza](/conoscere/le-quattro-fasi/soccorso/) — il modello di intervento.
- [Piano di Emergenza Comunale](/piano-emergenza/) — come Genzano si organizza.
