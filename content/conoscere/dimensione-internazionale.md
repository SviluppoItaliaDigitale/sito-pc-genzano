---
title: "La dimensione internazionale della protezione civile"
description: "Il Meccanismo europeo di protezione civile, rescEU e il Quadro di Sendai: come la protezione civile italiana si inserisce nei sistemi europeo e mondiale."
layout: "single"
toc: true
image: ""
date: 2026-05-29
...
<p class="mb-0"><i class="bi bi-info-circle me-2" aria-hidden="true"></i><strong>Una guida divulgativa.</strong> Questa pagina spiega la dimensione internazionale a scopo informativo, sulla base delle fonti della Commissione europea (DG ECHO), dell'UNDRR e del DPC. Il Gruppo Comunale Volontari di Protezione Civile di Genzano di Roma <strong>non parla a nome</strong> di questi enti.</p>
</div>
...
Ne abbiamo parlato in occasione della Giornata dell'Europa nella scheda [Il Meccanismo di protezione civile dell'Unione Europea](/comunicazioni/2026-05-09-giornata-europa-meccanismo-protezione-civile-ue/).
...
Fonte: UNDRR, [Sendai Framework 2015-2030](https://www.undrr.org/publication/sendai-framework-disaster-risk-reduction-2015-2030).
...
- [Il Meccanismo di protezione civile dell'Unione Europea](/comunicazioni/2026-05-09-giornata-europa-meccanismo-protezione-civile-ue/).
- [UNDRR e il Quadro di Sendai per la riduzione del rischio](/comunicazioni/2026-10-13-undrr-sendai-framework-riduzione-rischio-disastri/).
- [Superamento dell'emergenza](/conoscere/le-quattro-fasi/superamento/) — dove vive il «ricostruire meglio».
- [Standard internazionali ISO](/standard-iso/) e [Normativa](/normativa/) — il quadro tecnico e normativo.

## Per approfondire — fonti istituzionali

- [Commissione europea — Protezione civile e aiuti umanitari (DG ECHO)](https://civil-protection-humanitarian-aid.ec.europa.eu/) — Meccanismo unionale e rescEU.
- [UNDRR — Sendai Framework 2015-2030](https://www.undrr.org/publication/sendai-framework-disaster-risk-reduction-2015-2030).
- [DPC — Attività internazionali](https://www.protezionecivile.gov.it/it/) (Dipartimento della Protezione Civile).
