---
title: "San Pio da Pietrelcina, patrono dei Volontari di Protezione Civile"
description: "Breve biografia di San Pio da Pietrelcina, la sua canonizzazione e i motivi per cui è stato proclamato patrono dei Volontari della Protezione Civile italiana."
layout: "single"
toc: true
aliases:
  - /san-pio/
...
<div class="col-md-8">
<h2 class="h4 text-primary mb-3">Il patrono dei Volontari di Protezione Civile</h2>
<p class="mb-0">San Pio da Pietrelcina è il <strong>patrono dei Volontari della Protezione Civile italiana</strong>. La sua festa liturgica, il <strong>23 settembre</strong>, è il giorno in cui i Gruppi di volontariato di Protezione Civile di tutta Italia ricordano il proprio patrono.</p>
</div>
<div class="col-md-4 text-center">
<i class="bi bi-shield-shaded" style="font-size:5rem;color:var(--pc-primary);opacity:0.3;" aria-hidden="true"></i>
</div>
</div>
</div>
</div>
...
In caso di errori o imprecisioni, scrivere a [segreteria@protezionecivilegenzano.it](mailto:segreteria@protezionecivilegenzano.it): la pagina sarà corretta.
