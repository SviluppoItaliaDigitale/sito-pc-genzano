...
<div class="row mb-5">
{{< card-istituzionale icona="bi-building" titolo="Comune di Genzano di Roma" >}}
...
{{< /card-istituzionale >}}
{{< card-istituzionale icona="bi-people-fill" titolo="Gruppo volontari" bordo="var(--pc-secondary)" >}}
...
Il Gruppo aderisce a sistemi europei, nazionali e regionali di volontariato e protezione civile, sottoposti a verifica e accreditamento. Sono visibili nel footer di ogni pagina del sito.

<div class="row mb-5 affiliazioni-row">
{{< affiliazione-card logo="/images/quality-label-esc.png" alt="Logo Quality Label European Solidarity Corps" icona="bi-stars" titolo="Quality Label — European Solidarity Corps" >}}
<p class="small text-start mb-2">Il Gruppo è organizzazione accreditata dal <a href="https://youth.europa.eu/solidarity/organisations/quality-label_it" target="_blank" rel="noopener noreferrer">Corpo europeo di solidarietà</a> (European Solidarity Corps, ESC) della Commissione europea. Il Quality Label certifica che l'organizzazione rispetta i principi e i requisiti di qualità del programma per ospitare attività di volontariato europeo.</p>
<p class="small text-start mb-0"><strong>Codice di accreditamento:</strong> <code>E10435833</code><br><strong>Riferimento normativo:</strong> Regolamento (UE) 2021/888 del 20 maggio 2021.</p>
{{< /affiliazione-card >}}
{{< affiliazione-card logo="/images/logo-snpc-volontariato.png" alt="Logo Servizio Nazionale Protezione Civile — Volontariato" icona="bi-shield-fill-check" titolo="Servizio Nazionale di Protezione Civile" bordo="var(--pc-secondary)" larghezza="84px" altezza="98px" >}}
...
{{< /affiliazione-card >}}
{{< affiliazione-card logo="/images/logo-fepivol.png" alt="Logo Coordinamento FE.PI.VOL. — Federazione Pronto Intervento Volontariato ODV" icona="bi-people-fill" titolo="Coordinamento FE.PI.VOL." bordo="#15803d" >}}
<p class="small text-start mb-2">Il Gruppo aderisce al <strong>Coordinamento FE.PI.VOL.</strong> — Federazione Pronto Intervento Volontariato ODV, rete delle organizzazioni di volontariato di protezione civile del Lazio.</p>
<p class="small text-start mb-0">FEPIVOL coordina interventi sovracomunali, formazione condivisa, esercitazioni congiunte e rappresentanza delle organizzazioni di volontariato presso le istituzioni regionali.</p>
{{< /affiliazione-card >}}
</div>
...
<div class="row mb-5 affiliazioni-row">
{{< affiliazione-card logo="/images/logo-wikiprocessi-cima.svg" alt="Logo della piattaforma WikiProcessi di Fondazione CIMA" icona="bi-journal-check" titolo="WikiProcessi — Fondazione CIMA" bordo="#ff5000" larghezza="auto" altezza="60px" >}}
...
<i class="bi bi-people-fill me-2" aria-hidden="true"></i> Eletto il 14 ottobre 2023 — Quinquennio 2023-2028
</div>
...
<div class="row">
{{< mezzo-card nome="Land Rover Defender 130" descrizione="Pickup 4x4 con modulo antincendio da 600 litri." >}}
{{< mezzo-card nome="EVO Cross 4 Pickup" descrizione="Pickup 4x4 per trasporto persone o materiali." >}}
{{< mezzo-card nome="Nissan Cabstar" descrizione="Automezzo con piattaforma aerea." >}}
...
{{< mezzo-card colore="danger" nome="Mercedes Atego" descrizione="Mezzo polivalente con impianto AIB da 6.000 litri, spazzaneve e spargisale." >}}
{{< mezzo-card colore="success" nome="Iveco VM90" descrizione="Automezzo 4x4 con modulo antincendio da 800 litri." >}}
...
<div class="row mb-5">
{{< card-istituzionale classe="h5" icona="bi-broadcast-pin" titolo="Telecomunicazioni" >}}
...
{{< /card-istituzionale >}}
{{< card-istituzionale classe="h5" icona="bi-megaphone" colore="warning" bordo="var(--pc-secondary)" titolo="Web, social e divulgazione" >}}
...
{{< /card-istituzionale >}}
{{< card-istituzionale classe="h5" icona="bi-mortarboard" colore="success" bordo="#28a745" titolo="Divulgazione nelle scuole" >}}
...
{{< /card-istituzionale >}}
{{< card-istituzionale classe="h5" icona="bi-camera-reels" colore="purple" bordo="#6f42c1" titolo="Droni" >}}
...
{{< /card-istituzionale >}}
{{< card-istituzionale classe="h5" icona="bi-fire" colore="danger" bordo="#c1121f" titolo="Antincendio boschivo (AIB)" >}}
...
{{< /card-istituzionale >}}
{{< card-istituzionale classe="h5" icona="bi-droplet-fill" colore="info" bordo="#0369a1" titolo="Rischio idraulico e allagamenti" >}}
...
{{< foto src="/images/storica-gruppo-volontari-anni-90.webp"
         alt="Foto storica del Gruppo Comunale Volontari di Protezione Civile di Genzano di Roma negli anni Novanta: sei volontari in divisa azzurra schierati davanti a due automezzi del Gruppo, tra cui un'autobotte con la scritta 'Protezione Civile — Comune di Genzano di Roma'"
