...
- `genera-social-bozze.yml` — ogni push articolo e al termine di ogni deploy (chiamato da `deploy.yml`) → bozze social (X/FB/IG/Telegram) via Gemini API per ogni articolo online, calendarizzati compresi
