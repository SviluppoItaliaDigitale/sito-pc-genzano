...
🔴 **Due cose che la Sala non fa, ed è bene sapere perché.** Gli **aerei** non si possono mostrare in tempo reale: tutti i servizi che lo farebbero vietano di incorporarli, e quello che tecnicamente si incorporerebbe lo proibisce nelle proprie condizioni d'uso. La Sala mostra perciò i mezzi aerei da una fotografia aggiornata ogni quindici minuti, nella vista EMERGENZE. Per le **navi**, la mappa è quella del fornitore così com'è: il flusso di posizioni grezze si paga, quindi sul mare non si può filtrare né incrociare nulla con i nostri dati.
