...
- **MIA SALA** — le schede scelte da chi guarda, nell'ordine che vuole, anche prese da viste diverse. **Non si trascina niente e non ci sono spunte:** in cima a ogni scheda c'è il pulsante **☆ MIA SALA**; lo tocchi e la scheda finisce lì, lo tocchi di nuovo e la togli. Dentro la Mia Sala ogni scheda ha **▲ ▼** per spostarla e **✕** per toglierla. Su uno schermo largo (da 900 px in su) la Mia Sala **si apre a tutta pagina** e le schede vanno in colonne affiancate, così se ne vedono più insieme senza scorrere: è il motivo per cui la vista esiste. Sul telefono resta una colonna sola. Finché la sala è vuota, la pagina lo spiega in tre riquadri numerati — scegli la scheda, dove trovi il pulsante, come ordini — con l'elenco delle viste che lo hanno. Il pulsante compare sulle schede delle viste che la Mia Sala sa ricostruire — ALLERTA, SISMICO, METEO, ARIA·MARE, EMERGENZE, SATELLITI, REGISTRO — e non su quelle che incorporano una mappa di terzi o una tela (WINDY, TRAFFICO, NAVI, RADIO, CARTE), che non si possono duplicare. Nella Mia Sala la scheda si sposta con le frecce ▲ ▼ e si toglie con ✕: sono pulsanti e non trascinamento, perché il trascinamento da solo esclude chi usa la tastiera o ha poca precisione nel gesto. Se una scheda scelta al momento non ha dati, la Mia Sala lo dice in una riga e la rimette al suo posto appena la fonte torna, senza bisogno di cambiare vista.
...
**Lo stato dei pronto soccorso** apre la vista EMERGENZE: i dieci più vicini a Genzano, con quante persone sono in attesa e per quale codice di triage, aggiornati ogni minuto. Il dato è della Regione Lazio ed è pubblicato come open data. Serve a chi presidia la sala per farsi un'idea di quanto è carico il territorio — il Castelli di Ariccia è a 5 km, Velletri a 8, Frascati a 11.

**Non serve a scegliere dove andare, e la scheda lo dice per prima cosa: in emergenza si chiama il 112.** È la centrale che decide l'ospedale, in base alle condizioni della persona e alle specialità disponibili; un codice grave non fa la fila, e il pronto soccorso che sembra più sgombro può essere quello senza il reparto che serve. Una struttura che non risponde mostra un trattino e «stato non disponibile», mai zero: non avere il dato e non avere nessuno in attesa sono due cose opposte. Sulla copia di prova su GitHub Pages la scheda si spegne dichiarandolo, perché per questo dato non esiste una fotografia di riserva: un carico di ieri non direbbe nulla.
