              ...
              '<div class="menu-wrapper"><ul class="navbar-nav" role="menubar">' +
                ...
                '<li class="nav-item dropdown" role="none">' +
                  ...
                  '<div class="dropdown-menu" aria-labelledby="navDropdown-risorse"><div class="link-list-wrapper"><ul class="link-list" role="menu">' +
                    ...
                    '<li role="none"><a class="list-item" href="' + SITE_URL + '/manuale/" role="menuitem"><span>Manuale di Protezione Civile</span></a></li>' +
          ...
          '<section class="py-4"><div class="row">' +
            '<div class="col-lg-4 col-md-4 pb-2">' +
              ...
              '<div class="loghi-istituzionali d-flex align-items-center gap-3 flex-wrap mt-3" role="group" aria-label="Loghi istituzionali di appartenenza">' +
                '<img src="' + SITE_URL + '/images/logo-snpc-footer.webp" alt="Servizio Nazionale Protezione Civile — Volontariato" width="96" height="116" loading="lazy" style="background:#fff; border-radius:6px; padding:3px;">' +
                '<img src="' + SITE_URL + '/images/logo-pc-lazio-footer.webp" alt="Protezione Civile Regione Lazio" width="104" height="104" loading="lazy" style="background:#fff; border-radius:50%; padding:3px;">' +
                '<img src="' + SITE_URL + '/images/logo-fepivol-footer.webp" alt="Coordinamento FE.PI.VOL. — Federazione Pronto Intervento Volontariato ODV" width="104" height="104" loading="lazy" style="background:#fff; border-radius:50%; padding:3px;">' +
              '</div>' +
              '<div class="esc-quality-label d-flex align-items-center gap-2 mt-3">' +
                '<img src="' + SITE_URL + '/images/quality-label-esc-footer.webp" alt="Quality Label European Solidarity Corps" width="112" height="112" loading="lazy" style="background:#fff; border-radius:50%; padding:3px; flex-shrink:0;">' +
