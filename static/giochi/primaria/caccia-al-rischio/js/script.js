    ...
    function foundRisk(risk) {
        ...
        if (foundCount === currentVariation.risks.length) {
             setTimeout(() => {
                ...
                if (window.GiochiUtil) window.GiochiUtil.salvaEMostraAttestato('caccia-al-rischio', currentVariation.risks.length, currentVariation.risks.length, '#win-screen .win-box');
             }, 500);
        }
    }
