# Bozze social per «Terremoto: cosa fare durante e dopo la scossa»

Generate automaticamente da `scripts/genera-social.py` (motore: Gemini API).

- **Articolo**: https://www.protezionecivilegenzano.it/comunicazioni/2026-04-27-terremoto-cosa-fare-durante-dopo-la-scossa-facile/
- **Data**: 2026-04-27
- **Badge**: Prevenzione
