# Bozze social per «Caldo: come proteggere il tuo cane o gatto»

Generate automaticamente da `scripts/genera-social.py` (motore: Gemini API).

- **Articolo**: https://www.protezionecivilegenzano.it/comunicazioni/2026-04-23-cani-gatti-caldo-ondate-calore-facile/
- **Data**: 2026-04-23
- **Badge**: Prevenzione
