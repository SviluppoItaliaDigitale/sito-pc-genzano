# Bozze social per «App Where Are U: aiuta il 112 a trovarti»

Generate automaticamente da `scripts/genera-social.py` (motore: Gemini API).

- **Articolo**: https://www.protezionecivilegenzano.it/comunicazioni/2026-04-27-app-where-are-u-112-localizzazione-emergenza-facile/
- **Data**: 2026-04-27
- **Badge**: Informazione
