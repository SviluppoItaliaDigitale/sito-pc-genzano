# Bozze social per «Il piano di emergenza familiare — versione facile»

Generate automaticamente da `scripts/genera-social.py` (motore: Gemini API).

- **Articolo**: https://www.protezionecivilegenzano.it/comunicazioni/2026-04-26-piano-emergenza-familiare-5-passi-facile/
- **Data**: 2026-04-26
- **Badge**: Prevenzione
