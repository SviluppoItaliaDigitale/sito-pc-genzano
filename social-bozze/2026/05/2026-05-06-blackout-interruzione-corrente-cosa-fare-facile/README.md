# Bozze social per «Blackout: cosa fare quando non c'è corrente»

Generate automaticamente da `scripts/genera-social.py` (motore: Gemini API).

- **Articolo**: https://www.protezionecivilegenzano.it/comunicazioni/2026-05-06-blackout-interruzione-corrente-cosa-fare-facile/
- **Data**: 2026-05-06
- **Badge**: Prevenzione
