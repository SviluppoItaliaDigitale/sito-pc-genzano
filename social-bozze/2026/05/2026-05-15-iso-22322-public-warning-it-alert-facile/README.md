# Bozze social per «Come funziona l'allerta sul telefono? IT-alert spiegato facile»

Generate automaticamente da `scripts/genera-social.py` (motore: Gemini API).

- **Articolo**: https://www.protezionecivilegenzano.it/comunicazioni/2026-05-15-iso-22322-public-warning-it-alert-facile/
- **Data**: 2026-05-15
- **Badge**: Informazione
