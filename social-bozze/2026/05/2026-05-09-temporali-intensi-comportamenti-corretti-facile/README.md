# Bozze social per «Temporale: cosa fare. Versione facile da leggere»

Generate automaticamente da `scripts/genera-social.py` (motore: Gemini API).

- **Articolo**: https://www.protezionecivilegenzano.it/comunicazioni/2026-05-09-temporali-intensi-comportamenti-corretti-facile/
- **Data**: 2026-05-09
- **Badge**: Prevenzione
