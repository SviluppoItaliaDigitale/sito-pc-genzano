# Bozze social per «Stare sicuri al lago di Nemi e al lago di Albano»

Generate automaticamente da `scripts/genera-social.py` (motore: Gemini API).

- **Articolo**: https://www.protezionecivilegenzano.it/comunicazioni/2026-05-19-sicurezza-laghi-nemi-albano-facile/
- **Data**: 2026-05-19
- **Badge**: Prevenzione
