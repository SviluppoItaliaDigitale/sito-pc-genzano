# Bozze social per «Aiuta il tuo vicino fragile in caso di emergenza»

Generate automaticamente da `scripts/genera-social.py` (motore: Gemini API).

- **Articolo**: https://www.protezionecivilegenzano.it/comunicazioni/2026-05-05-persone-fragili-aiutare-vicini-anziani-emergenza-facile/
- **Data**: 2026-05-05
- **Badge**: Prevenzione
