# Bozze social per «Acqua in casa: cosa fare. Versione facile da leggere»

Generate automaticamente da `scripts/genera-social.py` (motore: Gemini API).

- **Articolo**: https://www.protezionecivilegenzano.it/comunicazioni/2026-05-02-allagamenti-urbani-cosa-fare-acqua-casa-facile/
- **Data**: 2026-05-02
- **Badge**: Prevenzione
