# Bozze social per «Emergenza e crisi: che differenza c'è? Versione facile da leggere»

Generate automaticamente da `scripts/genera-social.py` (motore: Gemini API).

- **Articolo**: https://www.protezionecivilegenzano.it/comunicazioni/2026-05-22-iso-22361-gestione-crisi-facile/
- **Data**: 2026-05-22
- **Badge**: Informazione
