# Bozze social per «Le zone di allerta del Lazio: come leggere il bollettino»

Generate automaticamente da `scripts/genera-social.py` (motore: Gemini API).

- **Articolo**: https://www.protezionecivilegenzano.it/comunicazioni/2026-05-07-zone-allerta-lazio-come-leggere-bollettino-facile/
- **Data**: 2026-05-07
- **Badge**: Informazione
