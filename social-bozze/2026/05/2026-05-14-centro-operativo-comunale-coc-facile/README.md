# Bozze social per «Il COC: la sala dove il Comune coordina l'emergenza»

Generate automaticamente da `scripts/genera-social.py` (motore: Gemini API).

- **Articolo**: https://www.protezionecivilegenzano.it/comunicazioni/2026-05-14-centro-operativo-comunale-coc-facile/
- **Data**: 2026-05-14
- **Badge**: Informazione
