# Bozze social per «I social nelle emergenze: come li usiamo bene. Versione facile»

Generate automaticamente da `scripts/genera-social.py` (motore: Gemini API).

- **Articolo**: https://www.protezionecivilegenzano.it/comunicazioni/2026-05-19-iso-22329-social-media-emergenza-facile/
- **Data**: 2026-05-19
- **Badge**: Informazione
