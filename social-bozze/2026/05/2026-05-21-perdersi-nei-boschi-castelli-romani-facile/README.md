# Bozze social per «Perdersi nel bosco: cosa fare»

Generate automaticamente da `scripts/genera-social.py` (motore: Gemini API).

- **Articolo**: https://www.protezionecivilegenzano.it/comunicazioni/2026-05-21-perdersi-nei-boschi-castelli-romani-facile/
- **Data**: 2026-05-21
- **Badge**: Prevenzione
