# Bozze social per «L'estintore: come funziona e come si usa»

Generate automaticamente da `scripts/genera-social.py` (motore: Gemini API).

- **Articolo**: https://www.protezionecivilegenzano.it/comunicazioni/2026-05-13-estintori-classi-fuoco-uso-corretto-manutenzione-facile/
- **Data**: 2026-05-13
- **Badge**: Prevenzione
