# Bozze social per «Piano di emergenza: fallo con tutta la famiglia»

Generate automaticamente da `scripts/genera-social.py` (motore: Gemini API).

- **Articolo**: https://www.protezionecivilegenzano.it/comunicazioni/2026-05-15-giornata-famiglie-piano-emergenza-insieme-facile/
- **Data**: 2026-05-15
- **Badge**: Prevenzione
