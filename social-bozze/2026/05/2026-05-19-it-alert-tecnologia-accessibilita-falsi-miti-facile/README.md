# Bozze social per «IT-alert: cos'è, come funziona, 5 cose false»

Generate automaticamente da `scripts/genera-social.py` (motore: Gemini API).

- **Articolo**: https://www.protezionecivilegenzano.it/comunicazioni/2026-05-19-it-alert-tecnologia-accessibilita-falsi-miti-facile/
- **Data**: 2026-05-19
- **Badge**: Informazione
