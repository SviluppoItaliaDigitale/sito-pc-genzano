# Bozze social per «Il 112: il numero per le emergenze»

Generate automaticamente da `scripts/genera-social.py` (motore: Gemini API).

- **Articolo**: https://www.protezionecivilegenzano.it/comunicazioni/2026-02-11-giornata-europea-112-numero-unico-facile/
- **Data**: 2026-02-11
- **Badge**: Informazione
