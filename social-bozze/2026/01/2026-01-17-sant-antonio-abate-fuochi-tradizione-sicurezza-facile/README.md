# Bozze social per «I fuochi di Sant'Antonio Abate: come stare sicuri»

Generate automaticamente da `scripts/genera-social.py` (motore: Gemini API).

- **Articolo**: https://www.protezionecivilegenzano.it/comunicazioni/2026-01-17-sant-antonio-abate-fuochi-tradizione-sicurezza-facile/
- **Data**: 2026-01-17
- **Badge**: Prevenzione
