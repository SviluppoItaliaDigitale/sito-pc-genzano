# Bozze social per «Ghiaccio sulle strade: cosa fare in inverno»

Generate automaticamente da `scripts/genera-social.py` (motore: Gemini API).

- **Articolo**: https://www.protezionecivilegenzano.it/comunicazioni/2026-01-23-gelate-ghiaccio-strade-comportamenti-invernali-facile/
- **Data**: 2026-01-23
- **Badge**: Prevenzione
