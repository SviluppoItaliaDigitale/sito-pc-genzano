# Bozze social per «Perché le allerte hanno colori? Versione facile da leggere»

Generate automaticamente da `scripts/genera-social.py` (motore: Gemini API).

- **Articolo**: https://www.protezionecivilegenzano.it/comunicazioni/2026-05-12-iso-22324-codici-colore-allerta-facile/
- **Data**: 2026-05-12
- **Badge**: Informazione
