# Bozze social per «Cucina senza sprechi: come usare tutto il cibo»

Generate automaticamente da `scripts/genera-social.py` (motore: Gemini API).

- **Articolo**: https://www.protezionecivilegenzano.it/comunicazioni/2025-10-16-cucina-zero-spreco-avanzi-recupero-facile/
- **Data**: 2025-10-16
- **Badge**: Prevenzione
