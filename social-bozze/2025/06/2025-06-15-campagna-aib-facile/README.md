# Bozze social per «Attenzione: rischio incendio boschivo dal 15 giugno»

Generate automaticamente da `scripts/genera-social.py` (motore: Gemini API).

- **Articolo**: https://www.protezionecivilegenzano.it/comunicazioni/2025-06-15-campagna-aib-facile/
- **Data**: 2025-06-15
- **Badge**: Prevenzione
