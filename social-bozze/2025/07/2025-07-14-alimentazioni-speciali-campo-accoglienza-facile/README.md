# Bozze social per «Cibo speciale nel campo di accoglienza»

Generate automaticamente da `scripts/genera-social.py` (motore: Gemini API).

- **Articolo**: https://www.protezionecivilegenzano.it/comunicazioni/2025-07-14-alimentazioni-speciali-campo-accoglienza-facile/
- **Data**: 2025-07-14
- **Badge**: Prevenzione
