...
3. la combina con `scripts/prompt-istruzioni-redazione.md` (system prompt pronto);
...
1. Apri l'app GitHub o il browser e vai su:
   <https://github.com/SviluppoItaliaDigitale/sito-pc-genzano/blob/main/CONTESTO-PROGETTO.md>
...
1. **Sul PC** apri `~/Scrivania/materiali-pacchetti/<tema>/00-INDICE.md` per le istruzioni passo-passo. Su mobile puoi navigare lo stesso pacchetto tramite GitHub web (mai pubblicato sul sito).
...
4. **Trascini i file** dentro `~/Scrivania/materiali-output/<tema>/` sul PC, OPPURE li alleghi in chat con Claude.
