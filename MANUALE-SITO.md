...
| `/formazione/schede-stampabili/` | `static/formazione/schede-stampabili/` | 105 schede HTML A4 stampabili (di cui 10 colorabili e 14 col curricolo a spirale 6-19 anni — stesso tema in più fasce) suddivise per fascia (infanzia/primaria/secondaria I/secondaria II) e disciplina (italiano, matematica, scienze, geografia, storia, ed. civica, giornalismo, diritto, economia, inglese) |
