...
| Parte 26 | Pagina Podcast + Scarica trascrizione PDF (12 maggio 2026) — Punto 15 roadmap. Pagina `/podcast/` con elenco di tutti gli articoli ascoltabili + durata stimata audio (`ReadingTime × 1.33` perché TTS è ~150 wpm vs 200 wpm di lettura visiva). Voce menu "Podcast" sotto Risorse. Bottone "Scarica trascrizione PDF" sopra ogni articolo (chiama `window.print()`, sfrutta il `@media print` globale del sito per produrre PDF puliti). Niente MP3, niente feed RSS, niente costi runtime | [`manuale/parte-26-podcast-pdf-trascrizione.md`](manuale/parte-26-podcast-pdf-trascrizione.md) |
